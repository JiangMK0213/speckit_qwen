...
**继承:** [THING.Krigingmap](./THING.Krigingmap.md)
...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | 参数列表 |
| param.minTransparentValue | `Number` | `2` | 是 | 展示结果时,小于minTransparentValue,且 transparent 为 true的颜色会变为透明 |
| param.transparent | `Number` | `true` | 是 | 展示结果时,小于minTransparentValue,且 transparent 为 true的颜色会变为透明 |
| param.variogramModel | `Number` | `"exponential"` | 是 | 计算变差函数时使用的模型 支持"gaussian" "exponential" "spherical"三种 |
| param.extent | `Number` | - | 是 | 热力图展示的范围 例如{minX:-50,minY:-50,maxX:50,maxY:50} 数值单位是米 代表绝对坐标 |
| param.minValue | `Number` | - | 是 | 展示结果时使用的最小值 如果不传 使用数据中的最小值 |
| param.maxValue | `Number` | - | 是 | 展示结果时使用的最大值 如果不传 使用数据中的最大值 |
| param.isoline | `Boolean` | `false` | 是 | 是否显示等值线 |
| param.auxiliaryLine | `Boolean` | `true` | 是 | isoline为true时 是否显示辅助等值线 |
| param.url | `String` | - | 否 | 数据源url 优先级高于data |
| param.data | `Array` | - | 否 | 创建插值图使用的数据源 |
| param.gradient | `Object` | `false` | 是 | 渲染插值图使用的色带 |
| param.mask | `Array` | - | 是 | 渲染插值图使用的遮罩 |
| param.offsetHeight | `Number` | `0` | 是 | 插值图离地高度 |
...
**数据类型:** `THING.VariogramModel`

**继承:** THING.Krigingmap#variogramModel

**重写:** THING.Krigingmap#variogramModel
...
```javascript
idwLayer.variogramModel=THING.VariogramModel.Spherical;
```
...
**继承:** THING.IDWmap#mask

**重写:** THING.Krigingmap#mask
...
**继承:** THING.IDWmap#exponent

**重写:** THING.Krigingmap#exponent

**描述:** 计算权重使用的幂值(仅IDWMap生效)
...
**继承:** THING.IDWmap#isoline

**重写:** THING.Krigingmap#isoline
...
**继承:** THING.IDWmap#auxiliaryLine

**重写:** THING.Krigingmap#auxiliaryLine
...
**继承:** THING.IDWmap#radius

**重写:** THING.Krigingmap#radius

**描述:** 插值图点位数据的影响半径 单位米(仅IDWMap生效)
...
**继承:** THING.Heatmap#transparent

**重写:** THING.Krigingmap#transparent
...
**继承:** THING.Heatmap#extrudeHeight

**重写:** THING.Krigingmap#extrudeHeight

**描述:** 热力图拔高 代表热力图热度最高位置拔起的高度 单位米

#### 示例

```javascript
heatMap.extrudeHeight = 100
```
...
**继承:** THING.Heatmap#gradient

**重写:** THING.Krigingmap#gradient
...
**继承:** THING.Heatmap#mosaic

**重写:** THING.Krigingmap#mosaic
...
```javascript
heatMap.mosaic = {enable:true,size:1};
```
...
**继承:** THING.Heatmap#extent

**重写:** THING.Krigingmap#extent
...
**继承:** THING.Heatmap#maskShape

**重写:** THING.Krigingmap#maskShape

**描述:** 基于maskShape作为展示热力图的对象 这里需要注意maskShape是一个xz平面的片,非地球模式下生效
...
**继承:** THING.Heatmap#minValue

**重写:** THING.Krigingmap#minValue
...
**继承:** THING.Heatmap#maxValue

**重写:** THING.Krigingmap#maxValue
...
**继承:** THING.Heatmap#minMaxRatio

**重写:** THING.Krigingmap#minMaxRatio
...
**继承:** THING.Heatmap#renderType

**重写:** THING.Krigingmap#renderType

**描述:** 热力图渲染模式 支持THING.HeatmapRenderType.Plane 普通2d热力图 与THING.HeatmapRenderType.Mesh 3d热力图对于非地球上使用mask的情况 目前使用3d热力图效果不明显

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `THING.HeatmapRenderType.Plane` | `HeatmapRenderType` | - |
...
**继承:** THING.Heatmap#data

**重写:** THING.Krigingmap#data
...
**重写:** THING.Krigingmap#isDynamicLoad
...
**重写:** THING.Krigingmap#frustumCulled
...
**重写:** THING.Krigingmap#renderOrder
...
**重写:** THING.Krigingmap#alwaysOnTop
...
**重写:** THING.Krigingmap#boundingBox
...
**重写:** THING.Krigingmap#orientedBox
...
**重写:** THING.Krigingmap#localPosition
...
**重写:** THING.Krigingmap#localAngles
...
**重写:** THING.Krigingmap#localRotation
...
**重写:** THING.Krigingmap#localQuaternion
...
**重写:** THING.Krigingmap#localScale
...
**重写:** THING.Krigingmap#quaternion
...
**重写:** THING.Krigingmap#ignoreParentTransform
...
**重写:** THING.Krigingmap#destroyable
...
**重写:** THING.Krigingmap#relationships
...
**重写:** THING.Krigingmap#components
...
**继承:** THING.IDWmap#setIsoline

**重写:** THING.Krigingmap#setIsoline
...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `contourSpacingValue` | `Number` | 等值线间距 |
| `lineThickness` | `Number` | 等值线宽度系数(不代表实际像素值) |
...
**继承:** THING.Heatmap#updateMapViewExtent

**重写:** THING.Krigingmap#updateMapViewExtent
...
**继承:** THING.Heatmap#setData

**重写:** THING.Krigingmap#setData
...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `data` | `Array.<Array.<Number>>` | [[x1 , y1 , value1],[x2 , y2 , value2]] |

#### 示例

```javascript
heatMap.setData([[0,0,10],[0,1,12],[0,2,11]]);//等同于heatMap.data = [[0,0,10],[0,1,12],[0,2,11]];
```
...
**重写:** THING.Krigingmap#getVisible
...
**重写:** THING.Krigingmap#setVisible
...
**重写:** THING.Krigingmap#setPickable
...
**重写:** THING.Krigingmap#getFrustumCulled
...
**重写:** THING.Krigingmap#setFrustumCulled
...
**重写:** THING.Krigingmap#distanceTo
...
**重写:** THING.Krigingmap#promoteNode
...
**重写:** THING.Krigingmap#waitForComplete
...
**重写:** THING.Krigingmap#loadResource
...
**重写:** THING.Krigingmap#unloadResource
...
**重写:** THING.Krigingmap#getRenderOrder
...
**重写:** THING.Krigingmap#setRenderOrder
...
**重写:** THING.Krigingmap#makeInstancedDrawing
...
**重写:** THING.Krigingmap#enableInstancing
...
**重写:** THING.Krigingmap#disableInstancing
...
**重写:** THING.Krigingmap#setInstancing
...
**重写:** THING.Krigingmap#getInstancing
...
**重写:** THING.Krigingmap#setInstancingColor
...
**重写:** THING.Krigingmap#setInstancingClearOutColor
...
**重写:** THING.Krigingmap#getInstancingClearOutColor
...
**重写:** THING.Krigingmap#setInstancingDiffuseUVTransform
...
**重写:** THING.Krigingmap#getInstancingDiffuseUVTransform
...
**重写:** THING.Krigingmap#setInstancingVisible
...
**重写:** THING.Krigingmap#getInstancingVisible
...
**重写:** THING.Krigingmap#getInstancedCount
...
**重写:** THING.Krigingmap#setInstancingMatrix
...
**重写:** THING.Krigingmap#getInstancingMatrix
...
**重写:** THING.Krigingmap#setInstancingAttribute
...
**重写:** THING.Krigingmap#getInstancingAttribute
...
**重写:** THING.Krigingmap#stopMoving
...
**重写:** THING.Krigingmap#pauseMoving
...
**重写:** THING.Krigingmap#resumeMoving
...
**重写:** THING.Krigingmap#movePathAsync
...
**重写:** THING.Krigingmap#stopScaling
...
**重写:** THING.Krigingmap#pauseScaling
...
**重写:** THING.Krigingmap#resumeScaling
...
**重写:** THING.Krigingmap#stopRotating
...
**重写:** THING.Krigingmap#pauseRotating
...
**重写:** THING.Krigingmap#resumeRotating
...
**重写:** THING.Krigingmap#stopFading
...
**重写:** THING.Krigingmap#pauseFading
...
**重写:** THING.Krigingmap#resumeFading
...
**重写:** THING.Krigingmap#fadeInAsync
...
**重写:** THING.Krigingmap#fadeOutAsync
...
**重写:** THING.Krigingmap#stopFlying
...
**重写:** THING.Krigingmap#pauseFlying
...
**重写:** THING.Krigingmap#resumeFlying
...
**重写:** THING.Krigingmap#stopUVTransform
...
**重写:** THING.Krigingmap#pauseUVTransform
...
**重写:** THING.Krigingmap#resumeUVTransform
...
**重写:** THING.Krigingmap#uvTransformTo
...
**重写:** THING.Krigingmap#rotateOnAxis
...
**重写:** THING.Krigingmap#translateX
...
**重写:** THING.Krigingmap#translateY
...
**重写:** THING.Krigingmap#translateZ
...
**重写:** THING.Krigingmap#worldToSelf
...
**重写:** THING.Krigingmap#selfToWorld
...
**重写:** THING.Krigingmap#localToWorld
...
**重写:** THING.Krigingmap#worldToLocal
...
**重写:** THING.Krigingmap#hasAttribute
...
**重写:** THING.Krigingmap#getAttribute
...
**重写:** THING.Krigingmap#setAttribute
...
**重写:** THING.Krigingmap#setAttributes
...
**重写:** THING.Krigingmap#pauseEvent
...
**重写:** THING.Krigingmap#resumeEvent
...
**重写:** THING.Krigingmap#queryByName
...
**重写:** THING.Krigingmap#queryByTags
...
**重写:** THING.Krigingmap#queryByUUID
...
**重写:** THING.Krigingmap#queryByType
...
**重写:** THING.Krigingmap#queryByDTType
...
**重写:** THING.Krigingmap#queryByUserData
...
**重写:** THING.Krigingmap#queryByRegExp
...
**重写:** THING.Krigingmap#addComponent
...
**重写:** THING.Krigingmap#removeComponent
...
**重写:** THING.Krigingmap#removeAllComponents
...
**重写:** THING.Krigingmap#traverseComponentByType
...
**重写:** THING.Krigingmap#getComponentByName
...
**重写:** THING.Krigingmap#getComponentByType
...
**重写:** THING.Krigingmap#getComponentsByType
...
**重写:** THING.Krigingmap#getAllComponents
...
**重写:** THING.Krigingmap#hasComponent
