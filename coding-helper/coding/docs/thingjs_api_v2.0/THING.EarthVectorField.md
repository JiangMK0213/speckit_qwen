...
**继承:** [THING.VectorField](./THING.VectorField.md)
...
| param.data | `Object` | - | 否 | 向量场使用的数据 需要有如下字段nx(列数),ny(行数),udata(数组),vdata(数组) |
| param.rowMajor | `Boolean` | `true` | 是 | 如果传入的数据是一维数组,rowMajor为true代表数组以行优先方式存储，如果是false则是以列优先方式存储 |
| param.extent | `Object` | `{minX:-180,maxX:180,minY:-90,maxY:90}` | 是 | 数据的经纬度范围 |
| param.numParticles | `Number` | `10000` | 是 | 粒子个数 |
| param.fadeOpacity | `Number` | `0.996` | 是 | 粒子消失的透明度 影像拖尾长度 值越小拖尾越短 |
| param.speed | `Number` | `1` | 是 | 粒子速度系数 |
| param.pointSize | `Number` | `3` | 是 | 点大小 数值需大于0 |
| param.gradient | `Object` | - | 是 | 渐变色 |
| param.mask | `Array` | - | 否 | 渲染向量场使用的遮罩 可传入geojson格式的多边形坐标 |
...
**继承:** THING.VectorField#extent

**重写:** THING.VectorField#extent

**描述:** 数据范围 格式为{minX,minY,maxX,maxY}
...
**继承:** THING.VectorField#numParticles

**重写:** THING.VectorField#numParticles
...
```javascript
vectorField.numParticles = 30000;
```
...
**继承:** THING.VectorField#fadeOpacity

**重写:** THING.VectorField#fadeOpacity

**描述:** 粒子消失的透明度 影像拖尾长度 值越小拖尾越短
...
**继承:** THING.VectorField#speed

**重写:** THING.VectorField#speed
...
**继承:** THING.VectorField#pointSize

**重写:** THING.VectorField#pointSize
...
**继承:** THING.VectorField#gradient

**重写:** THING.VectorField#gradient
...
```javascript
vectorField.gradient = { 0: "rgb(0,0,255)", 0.33: "rgb(0,255,0)",0.66: "rgb(255,255,0)",1.0: "rgb(255,0,0)"};
```
...
**重写:** THING.VectorField#isDynamicLoad
...
**重写:** THING.VectorField#layerMask
...
**重写:** THING.VectorField#frustumCulled
...
**重写:** THING.VectorField#renderOrder
...
**重写:** THING.VectorField#alwaysOnTop
...
**重写:** THING.VectorField#boundingBox
...
**重写:** THING.VectorField#orientedBox
...
**重写:** THING.VectorField#localPosition
...
**重写:** THING.VectorField#localAngles
...
**重写:** THING.VectorField#localRotation
...
**重写:** THING.VectorField#localQuaternion
...
**重写:** THING.VectorField#localScale
...
**重写:** THING.VectorField#quaternion
...
**重写:** THING.VectorField#ignoreParentTransform
...
**重写:** THING.VectorField#destroyable
...
**重写:** THING.VectorField#queryable
...
**重写:** THING.VectorField#relationships
...
**重写:** THING.VectorField#components
...
**重写:** THING.VectorField#getVisible
...
**重写:** THING.VectorField#setVisible
...
**重写:** THING.VectorField#setPickable
...
**重写:** THING.VectorField#getFrustumCulled
...
**重写:** THING.VectorField#setFrustumCulled
...
**重写:** THING.VectorField#distanceTo
...
**重写:** THING.VectorField#promoteNode
...
**重写:** THING.VectorField#waitForComplete
...
**重写:** THING.VectorField#loadResource
...
**重写:** THING.VectorField#unloadResource
...
**重写:** THING.VectorField#getRenderOrder
...
**重写:** THING.VectorField#setRenderOrder
...
**重写:** THING.VectorField#makeInstancedDrawing
...
**重写:** THING.VectorField#enableInstancing
...
**重写:** THING.VectorField#disableInstancing
...
**重写:** THING.VectorField#setInstancing
...
**重写:** THING.VectorField#getInstancing
...
**重写:** THING.VectorField#setInstancingColor
...
**重写:** THING.VectorField#setInstancingClearOutColor
...
**重写:** THING.VectorField#getInstancingClearOutColor
...
**重写:** THING.VectorField#setInstancingDiffuseUVTransform
...
**重写:** THING.VectorField#getInstancingDiffuseUVTransform
...
**重写:** THING.VectorField#setInstancingVisible
...
**重写:** THING.VectorField#getInstancingVisible
...
**重写:** THING.VectorField#getInstancedCount
...
**重写:** THING.VectorField#setInstancingMatrix
...
**重写:** THING.VectorField#getInstancingMatrix
...
**重写:** THING.VectorField#setInstancingAttribute
...
**重写:** THING.VectorField#getInstancingAttribute
...
**重写:** THING.VectorField#stopMoving
...
**重写:** THING.VectorField#pauseMoving
...
**重写:** THING.VectorField#resumeMoving
...
**重写:** THING.VectorField#movePathAsync
...
**重写:** THING.VectorField#stopScaling
...
**重写:** THING.VectorField#pauseScaling
...
**重写:** THING.VectorField#resumeScaling
...
**重写:** THING.VectorField#stopRotating
...
**重写:** THING.VectorField#pauseRotating
...
**重写:** THING.VectorField#resumeRotating
...
**重写:** THING.VectorField#stopFading
...
**重写:** THING.VectorField#pauseFading
...
**重写:** THING.VectorField#resumeFading
...
**重写:** THING.VectorField#fadeInAsync
...
**重写:** THING.VectorField#fadeOutAsync
...
**重写:** THING.VectorField#stopFlying
...
**重写:** THING.VectorField#pauseFlying
...
**重写:** THING.VectorField#resumeFlying
...
**重写:** THING.VectorField#stopUVTransform
...
**重写:** THING.VectorField#pauseUVTransform
...
**重写:** THING.VectorField#resumeUVTransform
...
**重写:** THING.VectorField#uvTransformTo
...
**重写:** THING.VectorField#rotateOnAxis
...
**重写:** THING.VectorField#translateX
...
**重写:** THING.VectorField#translateY
...
**重写:** THING.VectorField#translateZ
...
**重写:** THING.VectorField#translate
...
**重写:** THING.VectorField#worldToSelf
...
**重写:** THING.VectorField#selfToWorld
...
**重写:** THING.VectorField#localToWorld
...
**重写:** THING.VectorField#worldToLocal
...
**重写:** THING.VectorField#hasAttribute
...
**重写:** THING.VectorField#getAttribute
...
**重写:** THING.VectorField#setAttribute
...
**重写:** THING.VectorField#setAttributes
...
**重写:** THING.VectorField#pauseEvent
...
**重写:** THING.VectorField#resumeEvent
...
**重写:** THING.VectorField#queryByName
...
**重写:** THING.VectorField#queryById
...
**重写:** THING.VectorField#queryByTags
...
**重写:** THING.VectorField#queryByUUID
...
**重写:** THING.VectorField#queryByType
...
**重写:** THING.VectorField#queryByDTType
...
**重写:** THING.VectorField#queryByUserData
...
**重写:** THING.VectorField#queryByRegExp
...
**重写:** THING.VectorField#addComponent
...
**重写:** THING.VectorField#removeComponent
...
**重写:** THING.VectorField#removeAllComponents
...
**重写:** THING.VectorField#traverseComponentByType
...
**重写:** THING.VectorField#getComponentByName
...
**重写:** THING.VectorField#getComponentByType
...
**重写:** THING.VectorField#getComponentsByType
...
**重写:** THING.VectorField#getAllComponents
...
**重写:** THING.VectorField#hasComponent
