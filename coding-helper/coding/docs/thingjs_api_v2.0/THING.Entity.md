...
**继承:** [THING.BaseEntity](./THING.BaseEntity.md)

**描述:** 构造函数</br>也可用于在场景中加载预制资源的预制对象。

**参数:**

| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| param | `object` | - | 否 | 初始化参数 这里支持Object3D初始化的所有参数，此外可接受url作为资源路径 |
| param.url? | `string` | - | 否 | 资源路径 |
...
**数据类型:** `Array.<AnimationResult>`

**继承:** THING.BaseEntity#animations

**重写:** THING.BaseEntity#animations
...
**继承:** THING.BaseEntity#animationNames

**重写:** THING.BaseEntity#animationNames
...
**重写:** THING.BaseEntity#isDynamicLoad
...
**重写:** THING.BaseEntity#frustumCulled
...
**重写:** THING.BaseEntity#renderOrder
...
**重写:** THING.BaseEntity#alwaysOnTop
...
**重写:** THING.BaseEntity#boundingBox
...
**重写:** THING.BaseEntity#orientedBox
...
**重写:** THING.BaseEntity#localPosition
...
**重写:** THING.BaseEntity#localAngles
...
**重写:** THING.BaseEntity#localRotation
...
**重写:** THING.BaseEntity#localQuaternion
...
**重写:** THING.BaseEntity#localScale
...
**重写:** THING.BaseEntity#quaternion
...
**重写:** THING.BaseEntity#ignoreParentTransform
...
**重写:** THING.BaseEntity#destroyable
...
**重写:** THING.BaseEntity#relationships
...
**重写:** THING.BaseEntity#components
...
**继承:** THING.BaseEntity#playAnimation

**重写:** THING.BaseEntity#playAnimation

**描述:** 播放动画，会停止所有其他正在播放的动画

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `param` | `PlayAnimationArgs` | 参数 |
...
**继承:** THING.BaseEntity#blendAnimation

**重写:** THING.BaseEntity#blendAnimation

**描述:** 播放动画,播放时不会影响该物体正在播放的其他动画

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `param` | `PlayAnimationArgs` | 动画播放参数 |
...
**继承:** THING.BaseEntity#hasAnimation

**重写:** THING.BaseEntity#hasAnimation

**描述:** 根据动画名称检查该对象身上是否有这个动画
...
**继承:** THING.BaseEntity#isAnimationPlaying

**重写:** THING.BaseEntity#isAnimationPlaying
...
**继承:** THING.BaseEntity#pauseAnimation

**重写:** THING.BaseEntity#pauseAnimation
...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `name` | `string, Array.<string>` | 动画名称或动画名称的数组 |
...
**继承:** THING.BaseEntity#pauseAllAnimations

**重写:** THING.BaseEntity#pauseAllAnimations
...
**继承:** THING.BaseEntity#resumeAnimation

**重写:** THING.BaseEntity#resumeAnimation
...
**继承:** THING.BaseEntity#resumeAllAnimations

**重写:** THING.BaseEntity#resumeAllAnimations
...
**继承:** THING.BaseEntity#stopAnimation

**重写:** THING.BaseEntity#stopAnimation
...
**继承:** THING.BaseEntity#stopAllAnimations

**重写:** THING.BaseEntity#stopAllAnimations
...
**继承:** THING.BaseEntity#getAnimation

**重写:** THING.BaseEntity#getAnimation
...
**继承:** THING.BaseEntity#getAnimationState

**重写:** THING.BaseEntity#getAnimationState
...
**继承:** THING.BaseEntity#getPlayingAnimations

**重写:** THING.BaseEntity#getPlayingAnimations

**描述:** 获取所有正在播放的动画

#### 返回值

- **类型:** `Array.<AnimationResult>`
- **描述:** -
...
**继承:** THING.BaseEntity#getAnimationDirectionType

**重写:** THING.BaseEntity#getAnimationDirectionType
...
**继承:** THING.BaseEntity#setAnimationDirectionType

**重写:** THING.BaseEntity#setAnimationDirectionType
...
|------|------|-------------|
| `name` | `string` | 动画名称 |
| `value` | `AnimationDirectionType` | 方向类型(THING.AnimationDirectionType.Normal/THING.AnimationDirectionType.Reverse) |
...
**继承:** THING.BaseEntity#getAnimationSpeed

**重写:** THING.BaseEntity#getAnimationSpeed
...
**继承:** THING.BaseEntity#setAnimationSpeed

**重写:** THING.BaseEntity#setAnimationSpeed
...
**继承:** THING.BaseEntity#getAnimationWeight

**重写:** THING.BaseEntity#getAnimationWeight
...
**继承:** THING.BaseEntity#setAnimationWeight

**重写:** THING.BaseEntity#setAnimationWeight
...
**重写:** THING.BaseEntity#getVisible
...
**重写:** THING.BaseEntity#setVisible
...
**重写:** THING.BaseEntity#setPickable
...
**重写:** THING.BaseEntity#getFrustumCulled
...
**重写:** THING.BaseEntity#setFrustumCulled
...
**重写:** THING.BaseEntity#distanceTo
...
**重写:** THING.BaseEntity#waitForComplete
...
**重写:** THING.BaseEntity#loadResource
...
**重写:** THING.BaseEntity#unloadResource
...
**重写:** THING.BaseEntity#getRenderOrder
...
**重写:** THING.BaseEntity#setRenderOrder
...
**重写:** THING.BaseEntity#makeInstancedDrawing
...
**重写:** THING.BaseEntity#enableInstancing
...
**重写:** THING.BaseEntity#disableInstancing
...
**重写:** THING.BaseEntity#setInstancing
...
**重写:** THING.BaseEntity#getInstancing
...
**重写:** THING.BaseEntity#setInstancingColor
...
**重写:** THING.BaseEntity#setInstancingClearOutColor
...
**重写:** THING.BaseEntity#getInstancingClearOutColor
...
**重写:** THING.BaseEntity#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseEntity#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseEntity#setInstancingVisible
...
**重写:** THING.BaseEntity#getInstancingVisible
...
**重写:** THING.BaseEntity#getInstancedCount
...
**重写:** THING.BaseEntity#setInstancingMatrix
...
**重写:** THING.BaseEntity#getInstancingMatrix
...
**重写:** THING.BaseEntity#setInstancingAttribute
...
**重写:** THING.BaseEntity#getInstancingAttribute
...
**重写:** THING.BaseEntity#stopMoving
...
**重写:** THING.BaseEntity#pauseMoving
...
**重写:** THING.BaseEntity#resumeMoving
...
**重写:** THING.BaseEntity#movePathAsync
...
**重写:** THING.BaseEntity#stopScaling
...
**重写:** THING.BaseEntity#pauseScaling
...
**重写:** THING.BaseEntity#resumeScaling
...
**重写:** THING.BaseEntity#stopRotating
...
**重写:** THING.BaseEntity#pauseRotating
...
**重写:** THING.BaseEntity#resumeRotating
...
**重写:** THING.BaseEntity#stopFading
...
**重写:** THING.BaseEntity#pauseFading
...
**重写:** THING.BaseEntity#resumeFading
...
**重写:** THING.BaseEntity#fadeInAsync
...
**重写:** THING.BaseEntity#fadeOutAsync
...
**重写:** THING.BaseEntity#stopFlying
...
**重写:** THING.BaseEntity#pauseFlying
...
**重写:** THING.BaseEntity#resumeFlying
...
**重写:** THING.BaseEntity#stopUVTransform
...
**重写:** THING.BaseEntity#pauseUVTransform
...
**重写:** THING.BaseEntity#resumeUVTransform
...
**重写:** THING.BaseEntity#uvTransformTo
...
**重写:** THING.BaseEntity#rotateOnAxis
...
**重写:** THING.BaseEntity#translateX
...
**重写:** THING.BaseEntity#translateY
...
**重写:** THING.BaseEntity#translateZ
...
**重写:** THING.BaseEntity#worldToSelf
...
**重写:** THING.BaseEntity#selfToWorld
...
**重写:** THING.BaseEntity#localToWorld
...
**重写:** THING.BaseEntity#worldToLocal
...
**重写:** THING.BaseEntity#hasAttribute
...
**重写:** THING.BaseEntity#getAttribute
...
**重写:** THING.BaseEntity#setAttribute
...
**重写:** THING.BaseEntity#setAttributes
...
**重写:** THING.BaseEntity#pauseEvent
...
**重写:** THING.BaseEntity#resumeEvent
...
**重写:** THING.BaseEntity#queryByName
...
**重写:** THING.BaseEntity#queryByTags
...
**重写:** THING.BaseEntity#queryByUUID
...
**重写:** THING.BaseEntity#queryByType
...
**重写:** THING.BaseEntity#queryByDTType
...
**重写:** THING.BaseEntity#queryByUserData
...
**重写:** THING.BaseEntity#queryByRegExp
...
**重写:** THING.BaseEntity#addComponent
...
**重写:** THING.BaseEntity#removeComponent
...
**重写:** THING.BaseEntity#removeAllComponents
...
**重写:** THING.BaseEntity#traverseComponentByType
...
**重写:** THING.BaseEntity#getComponentByName
...
**重写:** THING.BaseEntity#getComponentByType
...
**重写:** THING.BaseEntity#getComponentsByType
...
**重写:** THING.BaseEntity#getAllComponents
...
**重写:** THING.BaseEntity#hasComponent
