...
**继承:** [THING.Marker](./THING.Marker.md)
...
|------|------|--------|-------------|--------|
| param | `object` | - | 否 | - |
| param.fontText | `string` | - | 否 | 文字内容 |
| param.fontType | `string` | `'Arial'` | 是 | 字体 |
| param.fontSize | `number` | `10` | 是 | 字号 |
| param.fontWeight | `FontWeight` | `THING.FontWeight.Normal` | 是 | 字体粗细 |
| param.fontLineWidth | `number` | `Infinity` | 是 | 文本换行最大宽度 |
| param.fontLineHeight | `number` | `0` | 是 | 文本换行高度 |
| param.fontColor | `Array.<number>, string` | `'#ffffff'` | 是 | 文本颜色 |
| param.fontShadowColor | `Array.<number>, string` | `'#000000'` | 是 | 阴影颜色 |
| param.fontShadowAlpha | `number` | `1.0` | 是 | 阴影透明度 |
| param.fontShadowAngle | `number` | `45` | 是 | 阴影旋转角度 |
| param.fontShadowBlur | `number` | `1` | 是 | 阴影模糊系数 |
| param.fontShadowDistance | `number` | `1` | 是 | 阴影距离 |
| param.fontAlignType | `AlignType` | `THING.AlignType.Center` | 是 | 文本对齐方式 |
| param.richText | `boolean` | `false` | 是 | 是否开启富文本模式 |
| param.mode | `string` | `'defalt'` | 是 | 文本渲染模式 包括 'sdf','default','msdf','msdf-woreker' |
...
**描述:** 获取/设置文本换行高度，单位：像素。0 表示自动调整尺寸
...
**继承:** THING.Marker#autoFitBodyScale

**重写:** THING.Marker#autoFitBodyScale

**描述:** 创建Marker是否自适应图片的宽高比 如果为false,图片会变形
...
**继承:** THING.Marker#scaleFactor

**重写:** THING.Marker#scaleFactor

**描述:** 设置/获取 自适应图片宽高比时的缩放倍数 仅autoFitBodyScale=true时生效
...
**默认值:** `THING.RenderType.Sprite`

**继承:** THING.Marker#renderType

**重写:** THING.Marker#renderType

**描述:** 设置/获取 渲染类型 支持精灵模式和平面模式
...
**继承:** THING.Marker#spriteRotation

**重写:** THING.Marker#spriteRotation

**描述:** 精灵模式下的旋转角度

---

### onBeforeFitBodyScale

**类型:** `member`

**数据类型:** `OnFitBodyScaleCallback`

**继承:** THING.Marker#onBeforeFitBodyScale

**重写:** THING.Marker#onBeforeFitBodyScale

**描述:** 获取/设置在适应图片尺寸之前调用的回调函数。
...
**继承:** THING.Marker#onAfterFitBodyScale

**重写:** THING.Marker#onAfterFitBodyScale

**描述:** 设置/获取 自适应图片尺寸结束后的回调
...
**数据类型:** `THING.ScaleMode`

**继承:** THING.Marker#scaleMode

**重写:** THING.Marker#scaleMode

**描述:** 设置/获取 缩放模式  (仅 autoFitBodyScale=true 时生效)
...
**重写:** THING.Marker#localQuaternion
...
**重写:** THING.Marker#ignoreParentTransform
...
**重写:** THING.Marker#getFrustumCulled
...
**重写:** THING.Marker#setFrustumCulled
...
**重写:** THING.Marker#waitForComplete
...
**重写:** THING.Marker#unloadResource
...
**重写:** THING.Marker#getRenderOrder
...
**重写:** THING.Marker#setRenderOrder
...
**重写:** THING.Marker#makeInstancedDrawing
...
**重写:** THING.Marker#enableInstancing
...
**重写:** THING.Marker#disableInstancing
...
**重写:** THING.Marker#setInstancingColor
...
**重写:** THING.Marker#setInstancingClearOutColor
...
**重写:** THING.Marker#getInstancingClearOutColor
...
**重写:** THING.Marker#setInstancingDiffuseUVTransform
...
**重写:** THING.Marker#getInstancingDiffuseUVTransform
...
**重写:** THING.Marker#setInstancingVisible
...
**重写:** THING.Marker#getInstancingVisible
...
**重写:** THING.Marker#getInstancedCount
...
**重写:** THING.Marker#setInstancingMatrix
...
**重写:** THING.Marker#getInstancingMatrix
...
**重写:** THING.Marker#setInstancingAttribute
...
**重写:** THING.Marker#getInstancingAttribute
...
**重写:** THING.Marker#resumeRotating
...
**重写:** THING.Marker#stopUVTransform
...
**重写:** THING.Marker#pauseUVTransform
...
**重写:** THING.Marker#resumeUVTransform
...
**重写:** THING.Marker#queryByUserData
...
**重写:** THING.Marker#removeComponent
...
**重写:** THING.Marker#removeAllComponents
...
**重写:** THING.Marker#traverseComponentByType
...
**重写:** THING.Marker#getComponentByName
...
**重写:** THING.Marker#getComponentByType
...
**重写:** THING.Marker#getComponentsByType
...
**重写:** THING.Marker#getAllComponents
