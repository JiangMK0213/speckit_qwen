...
**继承:** [THING.BaseModelObject3D](./THING.BaseModelObject3D.md)
...
| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| width | `number` | `1.0` | 是 | 宽度(自身x轴方向长度 单位:米) |
| height | `number` | `1.0` | 是 | 高度(自身y轴方向长度 单位:米) |
| depth | `number` | `1.0` | 是 | 深度(自身z轴方向长度 单位:米) |
| param | `object` | - | 否 | 初始化参数(与BaseObject3D初始化参数一致,例如postion,angles等) |
...
**重写:** THING.BaseModelObject3D#helper
...
**重写:** THING.BaseModelObject3D#lerp
...
**重写:** THING.BaseModelObject3D#level
...
**重写:** THING.BaseModelObject3D#collider
...
**重写:** THING.BaseModelObject3D#name
...
**重写:** THING.BaseModelObject3D#isDynamicLoad
...
**重写:** THING.BaseModelObject3D#layerMask
...
**重写:** THING.BaseModelObject3D#styleTag
...
**重写:** THING.BaseModelObject3D#inherit
...
**重写:** THING.BaseModelObject3D#visible
...
**重写:** THING.BaseModelObject3D#pickable
...
**重写:** THING.BaseModelObject3D#active
...
**重写:** THING.BaseModelObject3D#frustumCulled
...
**重写:** THING.BaseModelObject3D#keepSize
...
**重写:** THING.BaseModelObject3D#pivot
...
**重写:** THING.BaseModelObject3D#style
...
**重写:** THING.BaseModelObject3D#body
...
**重写:** THING.BaseModelObject3D#renderOrder
...
**重写:** THING.BaseModelObject3D#alwaysOnTop
...
**重写:** THING.BaseModelObject3D#boundingBox
...
**重写:** THING.BaseModelObject3D#orientedBox
...
**重写:** THING.BaseModelObject3D#isFlying
...
**重写:** THING.BaseModelObject3D#localPosition
...
**重写:** THING.BaseModelObject3D#localAngles
...
**重写:** THING.BaseModelObject3D#localRotation
...
**重写:** THING.BaseModelObject3D#localQuaternion
...
**重写:** THING.BaseModelObject3D#localScale
...
**重写:** THING.BaseModelObject3D#position
...
**重写:** THING.BaseModelObject3D#angles
...
**重写:** THING.BaseModelObject3D#rotation
...
**重写:** THING.BaseModelObject3D#quaternion
...
**重写:** THING.BaseModelObject3D#scale
...
**重写:** THING.BaseModelObject3D#ignoreParentTransform
...
**重写:** THING.BaseModelObject3D#app
...
**重写:** THING.BaseModelObject3D#type
...
**重写:** THING.BaseModelObject3D#dtType
...
**重写:** THING.BaseModelObject3D#uuid
...
**重写:** THING.BaseModelObject3D#tags
...
**重写:** THING.BaseModelObject3D#userData
...
**重写:** THING.BaseModelObject3D#destroyable
...
**重写:** THING.BaseModelObject3D#queryable
...
**重写:** THING.BaseModelObject3D#parent
...
**重写:** THING.BaseModelObject3D#relationships
...
**重写:** THING.BaseModelObject3D#parents
...
**重写:** THING.BaseModelObject3D#brothers
...
**重写:** THING.BaseModelObject3D#children
...
**重写:** THING.BaseModelObject3D#components
...
**重写:** THING.BaseModelObject3D#getVisible
...
**重写:** THING.BaseModelObject3D#setVisible
...
**重写:** THING.BaseModelObject3D#setPickable
...
**重写:** THING.BaseModelObject3D#getFrustumCulled
...
**重写:** THING.BaseModelObject3D#setFrustumCulled
...
**重写:** THING.BaseModelObject3D#distanceTo
...
**重写:** THING.BaseModelObject3D#add
...
**重写:** THING.BaseModelObject3D#promoteNode
...
**重写:** THING.BaseModelObject3D#raycast
...
**重写:** THING.BaseModelObject3D#setStyle
...
**重写:** THING.BaseModelObject3D#clone
...
**重写:** THING.BaseModelObject3D#waitForComplete
...
**重写:** THING.BaseModelObject3D#loadResource
...
**重写:** THING.BaseModelObject3D#unloadResource
...
**重写:** THING.BaseModelObject3D#copy
...
**重写:** THING.BaseModelObject3D#getRenderOrder
...
**重写:** THING.BaseModelObject3D#setRenderOrder
...
**重写:** THING.BaseModelObject3D#makeInstancedDrawing
...
**重写:** THING.BaseModelObject3D#enableInstancing
...
**重写:** THING.BaseModelObject3D#disableInstancing
...
**重写:** THING.BaseModelObject3D#setInstancing
...
**重写:** THING.BaseModelObject3D#getInstancing
...
**重写:** THING.BaseModelObject3D#setInstancingColor
...
**重写:** THING.BaseModelObject3D#setInstancingClearOutColor
...
**重写:** THING.BaseModelObject3D#getInstancingClearOutColor
...
**重写:** THING.BaseModelObject3D#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseModelObject3D#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseModelObject3D#setInstancingVisible
...
**重写:** THING.BaseModelObject3D#getInstancingVisible
...
**重写:** THING.BaseModelObject3D#getInstancedCount
...
**重写:** THING.BaseModelObject3D#setInstancingMatrix
...
**重写:** THING.BaseModelObject3D#getInstancingMatrix
...
**重写:** THING.BaseModelObject3D#setInstancingAttribute
...
**重写:** THING.BaseModelObject3D#getInstancingAttribute
...
**重写:** THING.BaseModelObject3D#getAABB
...
**重写:** THING.BaseModelObject3D#getOBB
...
**重写:** THING.BaseModelObject3D#stopMoving
...
**重写:** THING.BaseModelObject3D#pauseMoving
...
**重写:** THING.BaseModelObject3D#resumeMoving
...
**重写:** THING.BaseModelObject3D#moveTo
...
**重写:** THING.BaseModelObject3D#movePath
...
**重写:** THING.BaseModelObject3D#movePathAsync
...
**重写:** THING.BaseModelObject3D#stopScaling
...
**重写:** THING.BaseModelObject3D#pauseScaling
...
**重写:** THING.BaseModelObject3D#resumeScaling
...
**重写:** THING.BaseModelObject3D#scaleTo
...
**重写:** THING.BaseModelObject3D#stopRotating
...
**重写:** THING.BaseModelObject3D#pauseRotating
...
**重写:** THING.BaseModelObject3D#resumeRotating
...
**重写:** THING.BaseModelObject3D#rotateTo
...
**重写:** THING.BaseModelObject3D#stopFading
...
**重写:** THING.BaseModelObject3D#pauseFading
...
**重写:** THING.BaseModelObject3D#resumeFading
...
**重写:** THING.BaseModelObject3D#fadeIn
...
**重写:** THING.BaseModelObject3D#fadeOut
...
**重写:** THING.BaseModelObject3D#fadeInAsync
...
**重写:** THING.BaseModelObject3D#fadeOutAsync
...
**重写:** THING.BaseModelObject3D#stopFlying
...
**重写:** THING.BaseModelObject3D#pauseFlying
...
**重写:** THING.BaseModelObject3D#resumeFlying
...
**重写:** THING.BaseModelObject3D#flyTo
...
**重写:** THING.BaseModelObject3D#fit
...
**重写:** THING.BaseModelObject3D#stopUVTransform
...
**重写:** THING.BaseModelObject3D#pauseUVTransform
...
**重写:** THING.BaseModelObject3D#resumeUVTransform
...
**重写:** THING.BaseModelObject3D#uvTransformTo
...
**重写:** THING.BaseModelObject3D#rotate
...
**重写:** THING.BaseModelObject3D#rotateOnAxis
...
**重写:** THING.BaseModelObject3D#rotateX
...
**重写:** THING.BaseModelObject3D#rotateY
...
**重写:** THING.BaseModelObject3D#rotateZ
...
**重写:** THING.BaseModelObject3D#translateX
...
**重写:** THING.BaseModelObject3D#translateY
...
**重写:** THING.BaseModelObject3D#translateZ
...
**重写:** THING.BaseModelObject3D#translate
...
**重写:** THING.BaseModelObject3D#lookAt
...
**重写:** THING.BaseModelObject3D#worldToSelf
...
**重写:** THING.BaseModelObject3D#selfToWorld
...
**重写:** THING.BaseModelObject3D#localToWorld
...
**重写:** THING.BaseModelObject3D#worldToLocal
...
**重写:** THING.BaseModelObject3D#hasAttribute
...
**重写:** THING.BaseModelObject3D#getAttribute
...
**重写:** THING.BaseModelObject3D#setAttribute
...
**重写:** THING.BaseModelObject3D#setAttributes
...
**重写:** THING.BaseModelObject3D#destroy
...
**重写:** THING.BaseModelObject3D#once
...
**重写:** THING.BaseModelObject3D#off
...
**重写:** THING.BaseModelObject3D#pauseEvent
...
**重写:** THING.BaseModelObject3D#resumeEvent
...
**重写:** THING.BaseModelObject3D#trigger
...
**重写:** THING.BaseModelObject3D#invoke
...
**重写:** THING.BaseModelObject3D#remove
...
**重写:** THING.BaseModelObject3D#traverse
...
**重写:** THING.BaseModelObject3D#query
...
**重写:** THING.BaseModelObject3D#queryAll
...
**重写:** THING.BaseModelObject3D#queryByName
...
**重写:** THING.BaseModelObject3D#queryById
...
**重写:** THING.BaseModelObject3D#queryByTags
...
**重写:** THING.BaseModelObject3D#queryByUUID
...
**重写:** THING.BaseModelObject3D#queryByType
...
**重写:** THING.BaseModelObject3D#queryByDTType
...
**重写:** THING.BaseModelObject3D#queryByUserData
...
**重写:** THING.BaseModelObject3D#queryByRegExp
...
**重写:** THING.BaseModelObject3D#addComponent
...
**重写:** THING.BaseModelObject3D#removeComponent
...
**重写:** THING.BaseModelObject3D#removeAllComponents
...
**重写:** THING.BaseModelObject3D#traverseComponentByType
...
**重写:** THING.BaseModelObject3D#getComponentByName
...
**重写:** THING.BaseModelObject3D#getComponentByType
...
**重写:** THING.BaseModelObject3D#getComponentsByType
...
**重写:** THING.BaseModelObject3D#getAllComponents
...
**重写:** THING.BaseModelObject3D#hasComponent
