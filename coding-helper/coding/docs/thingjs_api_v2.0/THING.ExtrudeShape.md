...
**继承:** [THING.BaseDynamicPoints](./THING.BaseDynamicPoints.md)

**描述:** 创建一个ExtrudeShape对象，用于在场景中通过高度创建多边形形状。

**参数:**

| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| param | `object` | - | 否 | 初始化参数 |
| param.selfPlanePoints | `Array.<Array.<number>>` | - | 是 | 自身空间中的平面点 |
| param.selfPlaneHoles | `Array.<Array.<Array.<number>>>` | - | 是 | 自身空间中的平面孔洞 |
| param.selfHoles | `Array.<Array.<Array.<number>>>` | - | 是 | 自身空间中的孔洞 |
| param.holes | `Array.<Array.<Array.<number>>>` | - | 是 | 世界空间中的孔洞 |
| param.height | `number` | - | 是 | 拉伸高度 |
| param.visibleDirection | `string` | - | 是 | 可见方向，可选值：'Both'、'Top'、'Bottom' |
...
**数据类型:** `ExtrudeShapeDirection`

**描述:** 获取/设置生成底部或顶部面的可见性。
...
**重写:** THING.BaseDynamicPoints#number
...
**重写:** THING.BaseDynamicPoints#autoAdjustPosition
...
**重写:** THING.BaseDynamicPoints#selfPoints
...
**重写:** THING.BaseDynamicPoints#points
...
**重写:** THING.BaseDynamicPoints#localPoints
...
**重写:** THING.BaseDynamicPoints#length
...
**重写:** THING.BaseDynamicPoints#helper
...
**重写:** THING.BaseDynamicPoints#lerp
...
**重写:** THING.BaseDynamicPoints#level
...
**重写:** THING.BaseDynamicPoints#collider
...
**重写:** THING.BaseDynamicPoints#name
...
**重写:** THING.BaseDynamicPoints#isDynamicLoad
...
**重写:** THING.BaseDynamicPoints#layerMask
...
**重写:** THING.BaseDynamicPoints#styleTag
...
**重写:** THING.BaseDynamicPoints#inherit
...
**重写:** THING.BaseDynamicPoints#visible
...
**重写:** THING.BaseDynamicPoints#pickable
...
**重写:** THING.BaseDynamicPoints#active
...
**重写:** THING.BaseDynamicPoints#frustumCulled
...
**重写:** THING.BaseDynamicPoints#keepSize
...
**重写:** THING.BaseDynamicPoints#pivot
...
**重写:** THING.BaseDynamicPoints#style
...
**重写:** THING.BaseDynamicPoints#body
...
**重写:** THING.BaseDynamicPoints#renderOrder
...
**重写:** THING.BaseDynamicPoints#alwaysOnTop
...
**重写:** THING.BaseDynamicPoints#boundingBox
...
**重写:** THING.BaseDynamicPoints#orientedBox
...
**重写:** THING.BaseDynamicPoints#isFlying
...
**重写:** THING.BaseDynamicPoints#localPosition
...
**重写:** THING.BaseDynamicPoints#localAngles
...
**重写:** THING.BaseDynamicPoints#localRotation
...
**重写:** THING.BaseDynamicPoints#localQuaternion
...
**重写:** THING.BaseDynamicPoints#localScale
...
**重写:** THING.BaseDynamicPoints#position
...
**重写:** THING.BaseDynamicPoints#angles
...
**重写:** THING.BaseDynamicPoints#rotation
...
**重写:** THING.BaseDynamicPoints#quaternion
...
**重写:** THING.BaseDynamicPoints#scale
...
**重写:** THING.BaseDynamicPoints#ignoreParentTransform
...
**重写:** THING.BaseDynamicPoints#app
...
**重写:** THING.BaseDynamicPoints#type
...
**重写:** THING.BaseDynamicPoints#dtType
...
**重写:** THING.BaseDynamicPoints#uuid
...
**重写:** THING.BaseDynamicPoints#tags
...
**重写:** THING.BaseDynamicPoints#userData
...
**重写:** THING.BaseDynamicPoints#destroyable
...
**重写:** THING.BaseDynamicPoints#queryable
...
**重写:** THING.BaseDynamicPoints#parent
...
**重写:** THING.BaseDynamicPoints#relationships
...
**重写:** THING.BaseDynamicPoints#parents
...
**重写:** THING.BaseDynamicPoints#brothers
...
**重写:** THING.BaseDynamicPoints#children
...
**重写:** THING.BaseDynamicPoints#components
...
**重写:** THING.BaseDynamicPoints#getVisible
...
**重写:** THING.BaseDynamicPoints#setVisible
...
**重写:** THING.BaseDynamicPoints#setPickable
...
**重写:** THING.BaseDynamicPoints#getFrustumCulled
...
**重写:** THING.BaseDynamicPoints#setFrustumCulled
...
**重写:** THING.BaseDynamicPoints#distanceTo
...
**重写:** THING.BaseDynamicPoints#add
...
**重写:** THING.BaseDynamicPoints#promoteNode
...
**重写:** THING.BaseDynamicPoints#raycast
...
**重写:** THING.BaseDynamicPoints#setStyle
...
**重写:** THING.BaseDynamicPoints#clone
...
**重写:** THING.BaseDynamicPoints#waitForComplete
...
**重写:** THING.BaseDynamicPoints#loadResource
...
**重写:** THING.BaseDynamicPoints#unloadResource
...
**重写:** THING.BaseDynamicPoints#copy
...
**重写:** THING.BaseDynamicPoints#getRenderOrder
...
**重写:** THING.BaseDynamicPoints#setRenderOrder
...
**重写:** THING.BaseDynamicPoints#makeInstancedDrawing
...
**重写:** THING.BaseDynamicPoints#enableInstancing
...
**重写:** THING.BaseDynamicPoints#disableInstancing
...
**重写:** THING.BaseDynamicPoints#setInstancing
...
**重写:** THING.BaseDynamicPoints#getInstancing
...
**重写:** THING.BaseDynamicPoints#setInstancingColor
...
**重写:** THING.BaseDynamicPoints#setInstancingClearOutColor
...
**重写:** THING.BaseDynamicPoints#getInstancingClearOutColor
...
**重写:** THING.BaseDynamicPoints#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseDynamicPoints#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseDynamicPoints#setInstancingVisible
...
**重写:** THING.BaseDynamicPoints#getInstancingVisible
...
**重写:** THING.BaseDynamicPoints#getInstancedCount
...
**重写:** THING.BaseDynamicPoints#setInstancingMatrix
...
**重写:** THING.BaseDynamicPoints#getInstancingMatrix
...
**重写:** THING.BaseDynamicPoints#setInstancingAttribute
...
**重写:** THING.BaseDynamicPoints#getInstancingAttribute
...
**重写:** THING.BaseDynamicPoints#getAABB
...
**重写:** THING.BaseDynamicPoints#getOBB
...
**重写:** THING.BaseDynamicPoints#stopMoving
...
**重写:** THING.BaseDynamicPoints#pauseMoving
...
**重写:** THING.BaseDynamicPoints#resumeMoving
...
**重写:** THING.BaseDynamicPoints#moveTo
...
**重写:** THING.BaseDynamicPoints#movePath
...
**重写:** THING.BaseDynamicPoints#movePathAsync
...
**重写:** THING.BaseDynamicPoints#stopScaling
...
**重写:** THING.BaseDynamicPoints#pauseScaling
...
**重写:** THING.BaseDynamicPoints#resumeScaling
...
**重写:** THING.BaseDynamicPoints#scaleTo
...
**重写:** THING.BaseDynamicPoints#stopRotating
...
**重写:** THING.BaseDynamicPoints#pauseRotating
...
**重写:** THING.BaseDynamicPoints#resumeRotating
...
**重写:** THING.BaseDynamicPoints#rotateTo
...
**重写:** THING.BaseDynamicPoints#stopFading
...
**重写:** THING.BaseDynamicPoints#pauseFading
...
**重写:** THING.BaseDynamicPoints#resumeFading
...
**重写:** THING.BaseDynamicPoints#fadeIn
...
**重写:** THING.BaseDynamicPoints#fadeOut
...
**重写:** THING.BaseDynamicPoints#fadeInAsync
...
**重写:** THING.BaseDynamicPoints#fadeOutAsync
...
**重写:** THING.BaseDynamicPoints#stopFlying
...
**重写:** THING.BaseDynamicPoints#pauseFlying
...
**重写:** THING.BaseDynamicPoints#resumeFlying
...
**重写:** THING.BaseDynamicPoints#flyTo
...
**重写:** THING.BaseDynamicPoints#fit
...
**重写:** THING.BaseDynamicPoints#stopUVTransform
...
**重写:** THING.BaseDynamicPoints#pauseUVTransform
...
**重写:** THING.BaseDynamicPoints#resumeUVTransform
...
**重写:** THING.BaseDynamicPoints#uvTransformTo
...
**重写:** THING.BaseDynamicPoints#rotate
...
**重写:** THING.BaseDynamicPoints#rotateOnAxis
...
**重写:** THING.BaseDynamicPoints#rotateX
...
**重写:** THING.BaseDynamicPoints#rotateY
...
**重写:** THING.BaseDynamicPoints#rotateZ
...
**重写:** THING.BaseDynamicPoints#translateX
...
**重写:** THING.BaseDynamicPoints#translateY
...
**重写:** THING.BaseDynamicPoints#translateZ
...
**重写:** THING.BaseDynamicPoints#translate
...
**重写:** THING.BaseDynamicPoints#lookAt
...
**重写:** THING.BaseDynamicPoints#worldToSelf
...
**重写:** THING.BaseDynamicPoints#selfToWorld
...
**重写:** THING.BaseDynamicPoints#localToWorld
...
**重写:** THING.BaseDynamicPoints#worldToLocal
...
**重写:** THING.BaseDynamicPoints#hasAttribute
...
**重写:** THING.BaseDynamicPoints#getAttribute
...
**重写:** THING.BaseDynamicPoints#setAttribute
...
**重写:** THING.BaseDynamicPoints#setAttributes
...
**重写:** THING.BaseDynamicPoints#destroy
...
**重写:** THING.BaseDynamicPoints#once
...
**重写:** THING.BaseDynamicPoints#off
...
**重写:** THING.BaseDynamicPoints#pauseEvent
...
**重写:** THING.BaseDynamicPoints#resumeEvent
...
**重写:** THING.BaseDynamicPoints#trigger
...
**重写:** THING.BaseDynamicPoints#invoke
...
**重写:** THING.BaseDynamicPoints#remove
...
**重写:** THING.BaseDynamicPoints#traverse
...
**重写:** THING.BaseDynamicPoints#query
...
**重写:** THING.BaseDynamicPoints#queryAll
...
**重写:** THING.BaseDynamicPoints#queryByName
...
**重写:** THING.BaseDynamicPoints#queryById
...
**重写:** THING.BaseDynamicPoints#queryByTags
...
**重写:** THING.BaseDynamicPoints#queryByUUID
...
**重写:** THING.BaseDynamicPoints#queryByType
...
**重写:** THING.BaseDynamicPoints#queryByDTType
...
**重写:** THING.BaseDynamicPoints#queryByUserData
...
**重写:** THING.BaseDynamicPoints#queryByRegExp
...
**重写:** THING.BaseDynamicPoints#addComponent
...
**重写:** THING.BaseDynamicPoints#removeComponent
...
**重写:** THING.BaseDynamicPoints#removeAllComponents
...
**重写:** THING.BaseDynamicPoints#traverseComponentByType
...
**重写:** THING.BaseDynamicPoints#getComponentByName
...
**重写:** THING.BaseDynamicPoints#getComponentByType
...
**重写:** THING.BaseDynamicPoints#getComponentsByType
...
**重写:** THING.BaseDynamicPoints#getAllComponents
...
**重写:** THING.BaseDynamicPoints#hasComponent
