...
| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| param | `CylinderParam` | - | 否 | The initial parameters. |
...
**继承:** THING.Mesh#isMesh

**重写:** THING.Mesh#isMesh
...
**重写:** THING.Mesh#ignoreParentTransform
...
**继承:** THING.Mesh#setPosition

**重写:** THING.Mesh#setPosition
...
**继承:** THING.Mesh#getPosition

**重写:** THING.Mesh#getPosition
...
**继承:** THING.Mesh#setNormal

**重写:** THING.Mesh#setNormal
...
**继承:** THING.Mesh#getNormal

**重写:** THING.Mesh#getNormal
...
**重写:** THING.Mesh#getFrustumCulled
...
**重写:** THING.Mesh#setFrustumCulled
...
**重写:** THING.Mesh#makeInstancedDrawing
...
**重写:** THING.Mesh#enableInstancing
...
**重写:** THING.Mesh#disableInstancing
...
**重写:** THING.Mesh#setInstancingColor
...
**重写:** THING.Mesh#setInstancingClearOutColor
...
**重写:** THING.Mesh#getInstancingClearOutColor
...
**重写:** THING.Mesh#setInstancingDiffuseUVTransform
...
**重写:** THING.Mesh#getInstancingDiffuseUVTransform
...
**重写:** THING.Mesh#setInstancingVisible
...
**重写:** THING.Mesh#getInstancingVisible
...
**重写:** THING.Mesh#getInstancedCount
...
**重写:** THING.Mesh#setInstancingMatrix
...
**重写:** THING.Mesh#getInstancingMatrix
...
**重写:** THING.Mesh#setInstancingAttribute
...
**重写:** THING.Mesh#getInstancingAttribute
...
**重写:** THING.Mesh#pauseUVTransform
...
**重写:** THING.Mesh#resumeUVTransform
...
**重写:** THING.Mesh#removeAllComponents
...
**重写:** THING.Mesh#traverseComponentByType
...
**重写:** THING.Mesh#getComponentByName
...
**重写:** THING.Mesh#getComponentByType
...
**重写:** THING.Mesh#getComponentsByType
...
**重写:** THING.Mesh#getAllComponents
