...
| param.offsetHeight | `Number` | `0` | 是 | 离地高度 单位米 |
| param.complete | `function` | - | 是 | 图层创建完毕后的回调函数 |
| param.dataSource | `Array.<GeoJSON>` | - | 是 | 图层数据源 |
| param.url | `String` | - | 是 | 图层数据源的url |
| param.style | `THING.EARTH.GeoObjectStyle` | - | 是 | 图层样式 与创建FeatureLayer的样式一致 |
| param.extrudeHeight | `Number` | - | 是 | 拔高高度 单位米 |
| param.extrudeField | `String` | - | 是 | 拔高字段 |
| param.extrudeFactor | `Number` | `1` | 是 | 拔高倍数 |
| param.offsetHeightField | `String` | - | 是 | 离地高度字段 |
| param.offsetHeightFactor | `String` | - | 是 | 离地高度倍数 |
...
| param.sync | `Boolean` | `true` | 是 | 是否同步创建 |
...
**重写:** THING.EARTH.Layer#getExtent
