...
**继承:** [THING.EARTH.GeoBuildingStyle](./THING.EARTH.GeoBuildingStyle.md)
...
| param.textureSize | `Array.<Number>` | - | 是 | 纹理尺寸 单位米 数组 代表顶面x方向和y方向的贴图尺寸 如果不传,则顶面整体贴满 |
...
| param.outline | `GeoLineStyle` | - | 是 | 边线样式 |
| param.boundary | `GeoBoundaryStyle` | - | 是 | 围栏样式 围栏高度也写在该对象中 |
...
**数据类型:** `GeoBoundaryStyle`

**描述:** 获取/设置围栏样式 围栏的extrudeHeight属性也写在该对象中
...
**继承:** THING.EARTH.GeoBuildingStyle#envMap

**重写:** THING.EARTH.GeoBuildingStyle#envMap
...
**继承:** THING.EARTH.GeoBuildingStyle#aoMap

**重写:** THING.EARTH.GeoBuildingStyle#aoMap
...
**继承:** THING.EARTH.GeoBuildingStyle#window

**重写:** THING.EARTH.GeoBuildingStyle#window
...
**继承:** THING.EARTH.GeoBuildingStyle#repeat

**重写:** THING.EARTH.GeoBuildingStyle#repeat
...
**继承:** THING.EARTH.GeoBuildingStyle#color

**重写:** THING.EARTH.GeoBuildingStyle#color
...
**继承:** THING.EARTH.GeoBuildingStyle#opacity

**重写:** THING.EARTH.GeoBuildingStyle#opacity
...
**继承:** THING.EARTH.GeoBuildingStyle#metalness

**重写:** THING.EARTH.GeoBuildingStyle#metalness
...
**继承:** THING.EARTH.GeoBuildingStyle#roughness

**重写:** THING.EARTH.GeoBuildingStyle#roughness
...
**继承:** THING.EARTH.GeoBuildingStyle#specularFactor

**重写:** THING.EARTH.GeoBuildingStyle#specularFactor
...
**继承:** THING.EARTH.GeoBuildingStyle#gradient

**重写:** THING.EARTH.GeoBuildingStyle#gradient
...
**继承:** THING.EARTH.GeoBuildingStyle#sideType

**重写:** THING.EARTH.GeoBuildingStyle#sideType
...
**继承:** THING.EARTH.GeoBuildingStyle#textureWrap

**重写:** THING.EARTH.GeoBuildingStyle#textureWrap
...
**继承:** THING.EARTH.GeoPolygonStyle#textureSize

**重写:** THING.EARTH.GeoBuildingStyle#textureSize
...
**继承:** THING.EARTH.GeoBuildingStyle#url

**重写:** THING.EARTH.GeoBuildingStyle#url
...
**继承:** THING.EARTH.GeoBuildingStyle#speed

**重写:** THING.EARTH.GeoBuildingStyle#speed
...
**重写:** THING.EARTH.GeoBuildingStyle#effect
...
**重写:** THING.EARTH.GeoBuildingStyle#glowStrength
...
**重写:** THING.EARTH.GeoBuildingStyle#tailing
...
**重写:** THING.EARTH.GeoBuildingStyle#radial
...
**重写:** THING.EARTH.GeoBuildingStyle#depthTest
...
**重写:** THING.EARTH.GeoBuildingStyle#depthWrite
...
**重写:** THING.EARTH.GeoBuildingStyle#blending
...
**重写:** THING.EARTH.GeoBuildingStyle#lights
...
**重写:** THING.EARTH.GeoBuildingStyle#outlineColor
