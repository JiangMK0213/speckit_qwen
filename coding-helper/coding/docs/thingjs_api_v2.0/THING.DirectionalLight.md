...
**继承:** [THING.BaseShadowLight](./THING.BaseShadowLight.md)
...
| param.castShadow | `boolean` | - | 否 | 开启/关闭阴影效果 |
| param.shadowQuality | `number` | - | 否 | 阴影效果品质(2的n次幂的一个数值,数值越大质量越高) |
| param.shadowBias | `number` | - | 否 | 阴影偏移量 |
| param.shadowRange | `ShadowRangeInfo` | - | 否 | 阴影范围 |
| param.position | `Array.<number>` | - | 否 | 灯光位置 |
| param.target | `Array.<number>` | - | 否 | 灯光的目标位置 根据position和target可确定平行光方向 |
...
**重写:** THING.BaseShadowLight#castShadow
...
**描述:** 检查是否为DirectionalLight类型或继承自它。
...
**数据类型:** `ShadowQualityType, Number`

**继承:** THING.BaseShadowLight#shadowQuality

**重写:** THING.BaseShadowLight#shadowQuality
...
**继承:** THING.BaseShadowLight#shadowBias

**重写:** THING.BaseShadowLight#shadowBias
...
**数据类型:** `ShadowRangeInfo`

**继承:** THING.BaseShadowLight#shadowNormalBias

**重写:** THING.BaseShadowLight#shadowNormalBias
...
**继承:** THING.BaseShadowLight#shadowRange

**重写:** THING.BaseShadowLight#shadowRange
...
**继承:** THING.BaseShadowLight#target

**重写:** THING.BaseShadowLight#target

**描述:** 平行光看向的位置,根据target和自身的position可以确定朝向
...
**继承:** THING.BaseShadowLight#isBaseShadowLight

**重写:** THING.BaseShadowLight#isBaseShadowLight

**描述:** 检查是否为BaseShadowLight类型或继承自它。
...
**重写:** THING.BaseShadowLight#color
...
**重写:** THING.BaseShadowLight#intensity
...
**重写:** THING.BaseShadowLight#groups
...
**重写:** THING.BaseShadowLight#helper
...
**重写:** THING.BaseShadowLight#level
...
**重写:** THING.BaseShadowLight#collider
...
**重写:** THING.BaseShadowLight#isDynamicLoad
...
**重写:** THING.BaseShadowLight#layerMask
...
**重写:** THING.BaseShadowLight#styleTag
...
**重写:** THING.BaseShadowLight#inherit
...
**重写:** THING.BaseShadowLight#visible
...
**重写:** THING.BaseShadowLight#pickable
...
**重写:** THING.BaseShadowLight#active
...
**重写:** THING.BaseShadowLight#frustumCulled
...
**重写:** THING.BaseShadowLight#keepSize
...
**重写:** THING.BaseShadowLight#pivot
...
**重写:** THING.BaseShadowLight#style
...
**重写:** THING.BaseShadowLight#renderOrder
...
**重写:** THING.BaseShadowLight#alwaysOnTop
...
**重写:** THING.BaseShadowLight#boundingBox
...
**重写:** THING.BaseShadowLight#orientedBox
...
**重写:** THING.BaseShadowLight#isFlying
...
**重写:** THING.BaseShadowLight#localPosition
...
**重写:** THING.BaseShadowLight#localAngles
...
**重写:** THING.BaseShadowLight#localRotation
...
**重写:** THING.BaseShadowLight#localQuaternion
...
**重写:** THING.BaseShadowLight#localScale
...
**重写:** THING.BaseShadowLight#position
...
**重写:** THING.BaseShadowLight#angles
...
**重写:** THING.BaseShadowLight#rotation
...
**重写:** THING.BaseShadowLight#quaternion
...
**重写:** THING.BaseShadowLight#scale
...
**重写:** THING.BaseShadowLight#ignoreParentTransform
...
**重写:** THING.BaseShadowLight#dtType
...
**重写:** THING.BaseShadowLight#userData
...
**重写:** THING.BaseShadowLight#destroyable
...
**重写:** THING.BaseShadowLight#queryable
...
**重写:** THING.BaseShadowLight#parent
...
**重写:** THING.BaseShadowLight#relationships
...
**重写:** THING.BaseShadowLight#parents
...
**重写:** THING.BaseShadowLight#brothers
...
**重写:** THING.BaseShadowLight#children
...
**重写:** THING.BaseShadowLight#components
...
**重写:** THING.BaseShadowLight#getVisible
...
**重写:** THING.BaseShadowLight#setVisible
...
**重写:** THING.BaseShadowLight#setPickable
...
**重写:** THING.BaseShadowLight#getFrustumCulled
...
**重写:** THING.BaseShadowLight#setFrustumCulled
...
**重写:** THING.BaseShadowLight#distanceTo
...
**重写:** THING.BaseShadowLight#promoteNode
...
**重写:** THING.BaseShadowLight#raycast
...
**重写:** THING.BaseShadowLight#setStyle
...
**重写:** THING.BaseShadowLight#clone
...
**重写:** THING.BaseShadowLight#waitForComplete
...
**重写:** THING.BaseShadowLight#loadResource
...
**重写:** THING.BaseShadowLight#unloadResource
...
**重写:** THING.BaseShadowLight#getRenderOrder
...
**重写:** THING.BaseShadowLight#setRenderOrder
...
**重写:** THING.BaseShadowLight#makeInstancedDrawing
...
**重写:** THING.BaseShadowLight#enableInstancing
...
**重写:** THING.BaseShadowLight#disableInstancing
...
**重写:** THING.BaseShadowLight#setInstancing
...
**重写:** THING.BaseShadowLight#getInstancing
...
**重写:** THING.BaseShadowLight#setInstancingColor
...
**重写:** THING.BaseShadowLight#setInstancingClearOutColor
...
**重写:** THING.BaseShadowLight#getInstancingClearOutColor
...
**重写:** THING.BaseShadowLight#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseShadowLight#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseShadowLight#setInstancingVisible
...
**重写:** THING.BaseShadowLight#getInstancingVisible
...
**重写:** THING.BaseShadowLight#getInstancedCount
...
**重写:** THING.BaseShadowLight#setInstancingMatrix
...
**重写:** THING.BaseShadowLight#getInstancingMatrix
...
**重写:** THING.BaseShadowLight#setInstancingAttribute
...
**重写:** THING.BaseShadowLight#getInstancingAttribute
...
**重写:** THING.BaseShadowLight#getAABB
...
**重写:** THING.BaseShadowLight#getOBB
...
**重写:** THING.BaseShadowLight#stopMoving
...
**重写:** THING.BaseShadowLight#pauseMoving
...
**重写:** THING.BaseShadowLight#resumeMoving
...
**重写:** THING.BaseShadowLight#moveTo
...
**重写:** THING.BaseShadowLight#movePath
...
**重写:** THING.BaseShadowLight#movePathAsync
...
**重写:** THING.BaseShadowLight#stopScaling
...
**重写:** THING.BaseShadowLight#pauseScaling
...
**重写:** THING.BaseShadowLight#resumeScaling
...
**重写:** THING.BaseShadowLight#scaleTo
...
**重写:** THING.BaseShadowLight#stopRotating
...
**重写:** THING.BaseShadowLight#pauseRotating
...
**重写:** THING.BaseShadowLight#resumeRotating
...
**重写:** THING.BaseShadowLight#rotateTo
...
**重写:** THING.BaseShadowLight#stopFading
...
**重写:** THING.BaseShadowLight#pauseFading
...
**重写:** THING.BaseShadowLight#resumeFading
...
**重写:** THING.BaseShadowLight#fadeIn
...
**重写:** THING.BaseShadowLight#fadeOut
...
**重写:** THING.BaseShadowLight#fadeInAsync
...
**重写:** THING.BaseShadowLight#fadeOutAsync
...
**重写:** THING.BaseShadowLight#stopFlying
...
**重写:** THING.BaseShadowLight#pauseFlying
...
**重写:** THING.BaseShadowLight#resumeFlying
...
**重写:** THING.BaseShadowLight#flyTo
...
**重写:** THING.BaseShadowLight#stopUVTransform
...
**重写:** THING.BaseShadowLight#pauseUVTransform
...
**重写:** THING.BaseShadowLight#resumeUVTransform
...
**重写:** THING.BaseShadowLight#uvTransformTo
...
**重写:** THING.BaseShadowLight#rotate
...
**重写:** THING.BaseShadowLight#rotateOnAxis
...
**重写:** THING.BaseShadowLight#rotateX
...
**重写:** THING.BaseShadowLight#rotateY
...
**重写:** THING.BaseShadowLight#rotateZ
...
**重写:** THING.BaseShadowLight#translateX
...
**重写:** THING.BaseShadowLight#translateY
...
**重写:** THING.BaseShadowLight#translateZ
...
**重写:** THING.BaseShadowLight#translate
...
**重写:** THING.BaseShadowLight#lookAt
...
**重写:** THING.BaseShadowLight#worldToSelf
...
**重写:** THING.BaseShadowLight#selfToWorld
...
**重写:** THING.BaseShadowLight#localToWorld
...
**重写:** THING.BaseShadowLight#worldToLocal
...
**重写:** THING.BaseShadowLight#hasAttribute
...
**重写:** THING.BaseShadowLight#getAttribute
...
**重写:** THING.BaseShadowLight#setAttribute
...
**重写:** THING.BaseShadowLight#setAttributes
...
**重写:** THING.BaseShadowLight#destroy
...
**重写:** THING.BaseShadowLight#pauseEvent
...
**重写:** THING.BaseShadowLight#resumeEvent
...
**重写:** THING.BaseShadowLight#trigger
...
**重写:** THING.BaseShadowLight#invoke
...
**重写:** THING.BaseShadowLight#remove
...
**重写:** THING.BaseShadowLight#traverse
...
**重写:** THING.BaseShadowLight#query
...
**重写:** THING.BaseShadowLight#queryAll
...
**重写:** THING.BaseShadowLight#queryByName
...
**重写:** THING.BaseShadowLight#queryById
...
**重写:** THING.BaseShadowLight#queryByTags
...
**重写:** THING.BaseShadowLight#queryByUUID
...
**重写:** THING.BaseShadowLight#queryByType
...
**重写:** THING.BaseShadowLight#queryByDTType
...
**重写:** THING.BaseShadowLight#queryByUserData
...
**重写:** THING.BaseShadowLight#queryByRegExp
...
**重写:** THING.BaseShadowLight#addComponent
...
**重写:** THING.BaseShadowLight#removeComponent
...
**重写:** THING.BaseShadowLight#removeAllComponents
...
**重写:** THING.BaseShadowLight#traverseComponentByType
...
**重写:** THING.BaseShadowLight#getComponentByName
...
**重写:** THING.BaseShadowLight#getComponentByType
...
**重写:** THING.BaseShadowLight#getComponentsByType
...
**重写:** THING.BaseShadowLight#getAllComponents
...
**重写:** THING.BaseShadowLight#hasComponent
