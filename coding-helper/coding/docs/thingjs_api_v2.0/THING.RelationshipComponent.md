...
|------|------|-------------|
| `options` | `object` | - |
| `options.type` | `string` | 关系的类型。 |
| `options.name` | `string` | 关系的名称。 |
| `options.queryDirection` | `RelationshipDirection` | 查询方向。 |
...
|------|------|-------------|
| `type` | `string` | 关系的类型。 |
| `queryDirection` | `RelationshipDirection` | 查询方向。 |
