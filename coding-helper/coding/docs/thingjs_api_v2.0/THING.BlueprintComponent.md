...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `options` | `BlueprintComponentLoadArgs` | 选项。 |

#### 返回值

- **类型:** `THING.BlueprintComponent`
- **描述:** -
...
**描述:** 根据名称获取变量。变量存在则返回对应的变量，不存在则返回null。(如果有多蓝图，则返回第一个相等的属性)
