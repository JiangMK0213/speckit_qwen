...
**继承:** [THING.BasePoints](./THING.BasePoints.md)

**描述:** 场景中的点物体(可展示点云)，构造参数的优先级，url > points > selfPoints
...
| param.url | `string` | - | 是 | 点云文件路径 |
| param.points | `Array.<Array.<number>>` | - | 是 | 点的坐标数组（世界坐标系). |
| param.selfPoints | `Array.<Array.<number>>` | - | 是 | 点的坐标数组(自身坐标系). |
| param.autoAdjustPosition | `boolean` | `false` | 是 | 是否自动校正坐标 |
| param.colors | `Array.<Array.<number>>` | - | 是 | 点的颜色数组. |
| param.imageRatio | `number` | `1` | 是 | 贴图比例(如果点用贴图渲染的话) |
| param.size | `number` | `1` | 是 | 单个点尺寸 |
| param.sizeAttenuation | `number` | `false` | 是 | 尺寸是否随着摄像机远近而变化 |
| param.pickedIds | `Array.<number>` | - | 是 | 每个点的pickID的数组 长度与points长度一致 |
| param.styles | `object` | - | 是 | 点样式 |
...
**数据类型:** `Array.<Array.<number>>, Float32Array.<Number>`
...
**重写:** THING.BasePoints#autoAdjustPosition
...
**重写:** THING.BasePoints#selfPoints
...
**重写:** THING.BasePoints#localPoints
...
**重写:** THING.BasePoints#isDynamicLoad
...
**重写:** THING.BasePoints#frustumCulled
...
**重写:** THING.BasePoints#renderOrder
...
**重写:** THING.BasePoints#alwaysOnTop
...
**重写:** THING.BasePoints#boundingBox
...
**重写:** THING.BasePoints#orientedBox
...
**重写:** THING.BasePoints#localPosition
...
**重写:** THING.BasePoints#localAngles
...
**重写:** THING.BasePoints#localRotation
...
**重写:** THING.BasePoints#localQuaternion
...
**重写:** THING.BasePoints#localScale
...
**重写:** THING.BasePoints#quaternion
...
**重写:** THING.BasePoints#ignoreParentTransform
...
**重写:** THING.BasePoints#destroyable
...
**重写:** THING.BasePoints#relationships
...
**重写:** THING.BasePoints#components
...
**重写:** THING.BasePoints#getVisible
...
**重写:** THING.BasePoints#setVisible
...
**重写:** THING.BasePoints#setPickable
...
**重写:** THING.BasePoints#getFrustumCulled
...
**重写:** THING.BasePoints#setFrustumCulled
...
**重写:** THING.BasePoints#distanceTo
...
**重写:** THING.BasePoints#promoteNode
...
**重写:** THING.BasePoints#waitForComplete
...
**重写:** THING.BasePoints#loadResource
...
**重写:** THING.BasePoints#unloadResource
...
**重写:** THING.BasePoints#getRenderOrder
...
**重写:** THING.BasePoints#setRenderOrder
...
**重写:** THING.BasePoints#makeInstancedDrawing
...
**重写:** THING.BasePoints#enableInstancing
...
**重写:** THING.BasePoints#disableInstancing
...
**重写:** THING.BasePoints#setInstancing
...
**重写:** THING.BasePoints#getInstancing
...
**重写:** THING.BasePoints#setInstancingColor
...
**重写:** THING.BasePoints#setInstancingClearOutColor
...
**重写:** THING.BasePoints#getInstancingClearOutColor
...
**重写:** THING.BasePoints#setInstancingDiffuseUVTransform
...
**重写:** THING.BasePoints#getInstancingDiffuseUVTransform
...
**重写:** THING.BasePoints#setInstancingVisible
...
**重写:** THING.BasePoints#getInstancingVisible
...
**重写:** THING.BasePoints#getInstancedCount
...
**重写:** THING.BasePoints#setInstancingMatrix
...
**重写:** THING.BasePoints#getInstancingMatrix
...
**重写:** THING.BasePoints#setInstancingAttribute
...
**重写:** THING.BasePoints#getInstancingAttribute
...
**重写:** THING.BasePoints#stopMoving
...
**重写:** THING.BasePoints#pauseMoving
...
**重写:** THING.BasePoints#resumeMoving
...
**重写:** THING.BasePoints#movePathAsync
...
**重写:** THING.BasePoints#stopScaling
...
**重写:** THING.BasePoints#pauseScaling
...
**重写:** THING.BasePoints#resumeScaling
...
**重写:** THING.BasePoints#stopRotating
...
**重写:** THING.BasePoints#pauseRotating
...
**重写:** THING.BasePoints#resumeRotating
...
**重写:** THING.BasePoints#stopFading
...
**重写:** THING.BasePoints#pauseFading
...
**重写:** THING.BasePoints#resumeFading
...
**重写:** THING.BasePoints#fadeInAsync
...
**重写:** THING.BasePoints#fadeOutAsync
...
**重写:** THING.BasePoints#stopFlying
...
**重写:** THING.BasePoints#pauseFlying
...
**重写:** THING.BasePoints#resumeFlying
...
**重写:** THING.BasePoints#stopUVTransform
...
**重写:** THING.BasePoints#pauseUVTransform
...
**重写:** THING.BasePoints#resumeUVTransform
...
**重写:** THING.BasePoints#uvTransformTo
...
**重写:** THING.BasePoints#rotateOnAxis
...
**重写:** THING.BasePoints#translateX
...
**重写:** THING.BasePoints#translateY
...
**重写:** THING.BasePoints#translateZ
...
**重写:** THING.BasePoints#worldToSelf
...
**重写:** THING.BasePoints#selfToWorld
...
**重写:** THING.BasePoints#localToWorld
...
**重写:** THING.BasePoints#worldToLocal
...
**重写:** THING.BasePoints#hasAttribute
...
**重写:** THING.BasePoints#getAttribute
...
**重写:** THING.BasePoints#setAttribute
...
**重写:** THING.BasePoints#setAttributes
...
**重写:** THING.BasePoints#pauseEvent
...
**重写:** THING.BasePoints#resumeEvent
...
**重写:** THING.BasePoints#queryByName
...
**重写:** THING.BasePoints#queryByTags
...
**重写:** THING.BasePoints#queryByUUID
...
**重写:** THING.BasePoints#queryByType
...
**重写:** THING.BasePoints#queryByDTType
...
**重写:** THING.BasePoints#queryByUserData
...
**重写:** THING.BasePoints#queryByRegExp
...
**重写:** THING.BasePoints#addComponent
...
**重写:** THING.BasePoints#removeComponent
...
**重写:** THING.BasePoints#removeAllComponents
...
**重写:** THING.BasePoints#traverseComponentByType
...
**重写:** THING.BasePoints#getComponentByName
...
**重写:** THING.BasePoints#getComponentByType
...
**重写:** THING.BasePoints#getComponentsByType
...
**重写:** THING.BasePoints#getAllComponents
...
**重写:** THING.BasePoints#hasComponent
