...
**继承:** [THING.EARTH.GeoBuilding](./THING.EARTH.GeoBuilding.md)
...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | - |
| param.coordinates | `Array.<Number>` | - | 否 | 地理位置坐标 |
| param.id | `String, Number` | - | 是 | 地理物体对象 ID |
| param.name | `String` | - | 是 | 地理物体对象名称 |
| param.userData | `Object` | - | 是 | 物体自定义属性 |
| param.renderOrder | `Number` | `0` | 是 | 渲染顺序 |
| param.offsetHeight | `Number` | `0` | 是 | 离地高度 |
| param.offsetHeightField | `Number` | - | 是 | 离地高度字段 如果设置了离地高度字段 物体最终的离地高度为offsetHeight与物体的userData[offsetHeightField]的值的总和 |
| param.extrudeHeight | `Number` | - | 是 | 拔起的高度 单位:米 优先级高于extrudeField |
| param.extrudeFactor | `Number` | `1` | 是 | 高度放大倍数,与extrudeField配合使用，默认是1,优先级低于extrudeHeight |
| param.extrudeField | `String` | - | 是 | 高度属性字段 在userData中找该字段作为高度,优先级低于extrudeHeight |
| param.useMercatorUV | `Boolean` | `true` | 是 | 计算多边形uv时是否使用墨卡托投影 |
| param.arcType | `THING.EARTH.ArcType` | - | 是 | 创建多边形的绘制方式 |
| param.granularity | `Number` | `Math.PI/180` | 是 | 多边形三角化的精度 值越小精度越高 |
| param.style | `THING.EARTH.GeoPolygonStyle` | - | 是 | 多边形样式 |
| param.label | `THING.EARTH.GeoLabel` | - | 是 | 标注 |
| param.infoWindow | `THING.EARTH.InfoWindow` | - | 是 | 信息框 |
| param.visible | `Boolean` | `true` | 是 | 是否显示 |
| param.onComplete | `function` | - | 是 | 地理对象创建完毕后的回调 |
...
**继承:** THING.EARTH.GeoBuilding#extrudeHeight

**重写:** THING.EARTH.GeoBuilding#extrudeHeight

**描述:** 获取/设置拉伸高度(非离地高度) 单位：米
...
**继承:** THING.EARTH.GeoBuilding#extrudeFactor

**重写:** THING.EARTH.GeoBuilding#extrudeFactor
...
**继承:** THING.EARTH.GeoBuilding#extrudeField

**重写:** THING.EARTH.GeoBuilding#extrudeField
...
**继承:** THING.EARTH.GeoObject#style

**重写:** THING.EARTH.GeoBuilding#style
...
**继承:** THING.EARTH.GeoObject#coordinates

**重写:** THING.EARTH.GeoBuilding#coordinates
...
**继承:** THING.EARTH.GeoObject#visible

**重写:** THING.EARTH.GeoBuilding#visible
...
**继承:** THING.EARTH.GeoObject#centroid

**重写:** THING.EARTH.GeoBuilding#centroid
...
**继承:** THING.EARTH.GeoObject#center

**重写:** THING.EARTH.GeoBuilding#center
...
**继承:** THING.EARTH.GeoObject#offsetHeight

**重写:** THING.EARTH.GeoBuilding#offsetHeight
...
**继承:** THING.EARTH.GeoObject#offsetHeightField

**重写:** THING.EARTH.GeoBuilding#offsetHeightField
...
**继承:** THING.EARTH.GeoObject#offsetHeightFactor

**重写:** THING.EARTH.GeoBuilding#offsetHeightFactor

**描述:** 设置/获取从离地高度字段获取离地高度时,需要乘的系数
...
**重写:** THING.EARTH.GeoBuilding#helper
...
**重写:** THING.EARTH.GeoBuilding#lerp
...
**重写:** THING.EARTH.GeoBuilding#level
...
**重写:** THING.EARTH.GeoBuilding#collider
...
**重写:** THING.EARTH.GeoBuilding#name
...
**重写:** THING.EARTH.GeoBuilding#isDynamicLoad
...
**重写:** THING.EARTH.GeoBuilding#layerMask
...
**重写:** THING.EARTH.GeoBuilding#styleTag
...
**重写:** THING.EARTH.GeoBuilding#inherit
...
**重写:** THING.EARTH.GeoBuilding#pickable
...
**重写:** THING.EARTH.GeoBuilding#active
...
**重写:** THING.EARTH.GeoBuilding#frustumCulled
...
**重写:** THING.EARTH.GeoBuilding#keepSize
...
**重写:** THING.EARTH.GeoBuilding#pivot
...
**重写:** THING.EARTH.GeoBuilding#body
...
**重写:** THING.EARTH.GeoBuilding#renderOrder
...
**重写:** THING.EARTH.GeoBuilding#alwaysOnTop
...
**重写:** THING.EARTH.GeoBuilding#boundingBox
...
**重写:** THING.EARTH.GeoBuilding#orientedBox
...
**重写:** THING.EARTH.GeoBuilding#isFlying
...
**重写:** THING.EARTH.GeoBuilding#localPosition
...
**重写:** THING.EARTH.GeoBuilding#localAngles
...
**重写:** THING.EARTH.GeoBuilding#localRotation
...
**重写:** THING.EARTH.GeoBuilding#localQuaternion
...
**重写:** THING.EARTH.GeoBuilding#localScale
...
**重写:** THING.EARTH.GeoBuilding#position
...
**重写:** THING.EARTH.GeoBuilding#angles
...
**重写:** THING.EARTH.GeoBuilding#rotation
...
**重写:** THING.EARTH.GeoBuilding#quaternion
...
**重写:** THING.EARTH.GeoBuilding#scale
...
**重写:** THING.EARTH.GeoBuilding#ignoreParentTransform
...
**重写:** THING.EARTH.GeoBuilding#app
...
**重写:** THING.EARTH.GeoBuilding#type
...
**重写:** THING.EARTH.GeoBuilding#dtType
...
**重写:** THING.EARTH.GeoBuilding#uuid
...
**重写:** THING.EARTH.GeoBuilding#tags
...
**重写:** THING.EARTH.GeoBuilding#userData
...
**重写:** THING.EARTH.GeoBuilding#destroyable
...
**重写:** THING.EARTH.GeoBuilding#queryable
...
**重写:** THING.EARTH.GeoBuilding#parent
...
**重写:** THING.EARTH.GeoBuilding#relationships
...
**重写:** THING.EARTH.GeoBuilding#parents
...
**重写:** THING.EARTH.GeoBuilding#brothers
...
**重写:** THING.EARTH.GeoBuilding#children
...
**重写:** THING.EARTH.GeoBuilding#components
...
**继承:** THING.EARTH.GeoObject#toGeoJSONGeometry

**重写:** THING.EARTH.GeoBuilding#toGeoJSONGeometry

**描述:** 导出 GeoJSON 格式的几何体对象

#### 返回值

- **类型:** `GeoJSON`
- **描述:** GeoJSON格式的Geometry对象
...
**继承:** THING.EARTH.GeoObject#toGeoJSON

**重写:** THING.EARTH.GeoBuilding#toGeoJSON

**描述:** 获取 GeoJSON 格式的 Feature 对象

#### 返回值

- **类型:** `GeoJSON`
- **描述:** GeoJSON格式的Feature对象
...
**继承:** THING.EARTH.GeoObject#getExtent

**重写:** THING.EARTH.GeoBuilding#getExtent
...
**继承:** THING.EARTH.GeoObject#getArea

**重写:** THING.EARTH.GeoBuilding#getArea
...
**继承:** THING.EARTH.GeoObject#getLength

**重写:** THING.EARTH.GeoBuilding#getLength
...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `isSpherical` | `Boolean` | 是计算球面距离还是直连的距离 |
...
**继承:** THING.EARTH.GeoObject#updateStyle

**重写:** THING.EARTH.GeoBuilding#updateStyle
...
|------|------|-------------|
| `value` | `Object` | 要更新的样式 |
| `shareMaterial` | `Boolean` | 是否共用材质 默认false，只有图层多级的情况下是true |
...
**继承:** THING.EARTH.GeoObject#setStyle

**重写:** THING.EARTH.GeoBuilding#setStyle
...
**继承:** THING.EARTH.GeoObject#update

**重写:** THING.EARTH.GeoBuilding#update

**描述:** 全量更新对象的属性 包括style offsetHeight extrudeHeight等
...
**继承:** THING.EARTH.GeoObject#movePath

**重写:** THING.EARTH.GeoBuilding#movePath
...
**继承:** THING.EARTH.GeoObject#movePathAsync

**重写:** THING.EARTH.GeoBuilding#movePathAsync
...
**重写:** THING.EARTH.GeoBuilding#getVisible
...
**重写:** THING.EARTH.GeoBuilding#setVisible
...
**重写:** THING.EARTH.GeoBuilding#setPickable
...
**重写:** THING.EARTH.GeoBuilding#getFrustumCulled
...
**重写:** THING.EARTH.GeoBuilding#setFrustumCulled
...
**重写:** THING.EARTH.GeoBuilding#distanceTo
...
**重写:** THING.EARTH.GeoBuilding#add
...
**重写:** THING.EARTH.GeoBuilding#promoteNode
...
**重写:** THING.EARTH.GeoBuilding#raycast
...
**重写:** THING.EARTH.GeoBuilding#clone
...
**重写:** THING.EARTH.GeoBuilding#waitForComplete
...
**重写:** THING.EARTH.GeoBuilding#loadResource
...
**重写:** THING.EARTH.GeoBuilding#unloadResource
...
**重写:** THING.EARTH.GeoBuilding#copy
...
**重写:** THING.EARTH.GeoBuilding#getRenderOrder
...
**重写:** THING.EARTH.GeoBuilding#setRenderOrder
...
**重写:** THING.EARTH.GeoBuilding#makeInstancedDrawing
...
**重写:** THING.EARTH.GeoBuilding#enableInstancing
...
**重写:** THING.EARTH.GeoBuilding#disableInstancing
...
**重写:** THING.EARTH.GeoBuilding#setInstancing
...
**重写:** THING.EARTH.GeoBuilding#getInstancing
...
**重写:** THING.EARTH.GeoBuilding#setInstancingColor
...
**重写:** THING.EARTH.GeoBuilding#setInstancingClearOutColor
...
**重写:** THING.EARTH.GeoBuilding#getInstancingClearOutColor
...
**重写:** THING.EARTH.GeoBuilding#setInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.GeoBuilding#getInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.GeoBuilding#setInstancingVisible
...
**重写:** THING.EARTH.GeoBuilding#getInstancingVisible
...
**重写:** THING.EARTH.GeoBuilding#getInstancedCount
...
**重写:** THING.EARTH.GeoBuilding#setInstancingMatrix
...
**重写:** THING.EARTH.GeoBuilding#getInstancingMatrix
...
**重写:** THING.EARTH.GeoBuilding#setInstancingAttribute
...
**重写:** THING.EARTH.GeoBuilding#getInstancingAttribute
...
**重写:** THING.EARTH.GeoBuilding#getAABB
...
**重写:** THING.EARTH.GeoBuilding#getOBB
...
**重写:** THING.EARTH.GeoBuilding#stopMoving
...
**重写:** THING.EARTH.GeoBuilding#pauseMoving
...
**重写:** THING.EARTH.GeoBuilding#resumeMoving
...
**重写:** THING.EARTH.GeoBuilding#moveTo
...
**重写:** THING.EARTH.GeoBuilding#stopScaling
...
**重写:** THING.EARTH.GeoBuilding#pauseScaling
...
**重写:** THING.EARTH.GeoBuilding#resumeScaling
...
**重写:** THING.EARTH.GeoBuilding#scaleTo
...
**重写:** THING.EARTH.GeoBuilding#stopRotating
...
**重写:** THING.EARTH.GeoBuilding#pauseRotating
...
**重写:** THING.EARTH.GeoBuilding#resumeRotating
...
**重写:** THING.EARTH.GeoBuilding#rotateTo
...
**重写:** THING.EARTH.GeoBuilding#stopFading
...
**重写:** THING.EARTH.GeoBuilding#pauseFading
...
**重写:** THING.EARTH.GeoBuilding#resumeFading
...
**重写:** THING.EARTH.GeoBuilding#fadeIn
...
**重写:** THING.EARTH.GeoBuilding#fadeOut
...
**重写:** THING.EARTH.GeoBuilding#fadeInAsync
...
**重写:** THING.EARTH.GeoBuilding#fadeOutAsync
...
**重写:** THING.EARTH.GeoBuilding#stopFlying
...
**重写:** THING.EARTH.GeoBuilding#pauseFlying
...
**重写:** THING.EARTH.GeoBuilding#resumeFlying
...
**重写:** THING.EARTH.GeoBuilding#flyTo
...
**重写:** THING.EARTH.GeoBuilding#fit
...
**重写:** THING.EARTH.GeoBuilding#stopUVTransform
...
**重写:** THING.EARTH.GeoBuilding#pauseUVTransform
...
**重写:** THING.EARTH.GeoBuilding#resumeUVTransform
...
**重写:** THING.EARTH.GeoBuilding#uvTransformTo
...
**重写:** THING.EARTH.GeoBuilding#rotate
...
**重写:** THING.EARTH.GeoBuilding#rotateOnAxis
...
**重写:** THING.EARTH.GeoBuilding#rotateX
...
**重写:** THING.EARTH.GeoBuilding#rotateY
...
**重写:** THING.EARTH.GeoBuilding#rotateZ
...
**重写:** THING.EARTH.GeoBuilding#translateX
...
**重写:** THING.EARTH.GeoBuilding#translateY
...
**重写:** THING.EARTH.GeoBuilding#translateZ
...
**重写:** THING.EARTH.GeoBuilding#translate
...
**重写:** THING.EARTH.GeoBuilding#lookAt
...
**重写:** THING.EARTH.GeoBuilding#worldToSelf
...
**重写:** THING.EARTH.GeoBuilding#selfToWorld
...
**重写:** THING.EARTH.GeoBuilding#localToWorld
...
**重写:** THING.EARTH.GeoBuilding#worldToLocal
...
**重写:** THING.EARTH.GeoBuilding#hasAttribute
...
**重写:** THING.EARTH.GeoBuilding#getAttribute
...
**重写:** THING.EARTH.GeoBuilding#setAttribute
...
**重写:** THING.EARTH.GeoBuilding#setAttributes
...
**重写:** THING.EARTH.GeoBuilding#destroy
...
**重写:** THING.EARTH.GeoBuilding#once
...
**重写:** THING.EARTH.GeoBuilding#off
...
**重写:** THING.EARTH.GeoBuilding#pauseEvent
...
**重写:** THING.EARTH.GeoBuilding#resumeEvent
...
**重写:** THING.EARTH.GeoBuilding#trigger
...
**重写:** THING.EARTH.GeoBuilding#invoke
...
**重写:** THING.EARTH.GeoBuilding#remove
...
**重写:** THING.EARTH.GeoBuilding#traverse
...
**重写:** THING.EARTH.GeoBuilding#query
...
**重写:** THING.EARTH.GeoBuilding#queryAll
...
**重写:** THING.EARTH.GeoBuilding#queryByName
...
**重写:** THING.EARTH.GeoBuilding#queryById
...
**重写:** THING.EARTH.GeoBuilding#queryByTags
...
**重写:** THING.EARTH.GeoBuilding#queryByUUID
...
**重写:** THING.EARTH.GeoBuilding#queryByType
...
**重写:** THING.EARTH.GeoBuilding#queryByDTType
...
**重写:** THING.EARTH.GeoBuilding#queryByUserData
...
**重写:** THING.EARTH.GeoBuilding#queryByRegExp
...
**重写:** THING.EARTH.GeoBuilding#addComponent
...
**重写:** THING.EARTH.GeoBuilding#removeComponent
...
**重写:** THING.EARTH.GeoBuilding#removeAllComponents
...
**重写:** THING.EARTH.GeoBuilding#traverseComponentByType
...
**重写:** THING.EARTH.GeoBuilding#getComponentByName
...
**重写:** THING.EARTH.GeoBuilding#getComponentByType
...
**重写:** THING.EARTH.GeoBuilding#getComponentsByType
...
**重写:** THING.EARTH.GeoBuilding#getAllComponents
...
**重写:** THING.EARTH.GeoBuilding#hasComponent
