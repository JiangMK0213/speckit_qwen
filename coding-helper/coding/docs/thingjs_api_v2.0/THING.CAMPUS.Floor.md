...
**数据类型:** `THING.Selector.<THING.Object3D>`
...
**数据类型:** `THING.Selector.<THING.Room>`
...
**数据类型:** `THING.Selector.<THING.Door>`
...
**描述:** 显示/隐藏所有屋顶（包括楼层和楼层下方房间的屋顶）

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `visible` | `Boolean` | true 显示（默认）/ false 隐藏 |
