...
**继承:** [THING.BaseLine](./THING.BaseLine.md)
...
| param.points | `Array.<Array.<number>>` | - | 否 | 路径坐标的数组 |
| param.radius | `number` | `0.5` | 是 | 管线半径大小(单位米) |
| param.cornerRadius | `number` | `0.3` | 是 | 拐角半径 |
| param.cornerSplit | `number` | `10` | 是 | 拐角分割面数，数值越大拐角越平滑 |
| param.radialSegments | `number` | `8` | 是 | 管线精细度，数值越大拐角越精细 |
| param.startDegree | `number` | `0` | 是 | 起始角度值(沿着管线路径方向顺时针旋转的角度) |
| param.uvScroll | `boolean` | `false` | 是 | 是否开启贴图流动 |
| param.uvScrollSpeed | `Array.<number>` | `[1,0]` | 是 | 贴图流动速度 |
| param.style | `object` | - | 是 | 线样式 |
...
**描述:** 获取/设置拐角分割面数，数值越大拐角越平滑(必须是整数)
...
**描述:** 获取/设置管线精细度，数值越大拐角越精细(必须是大于2的整数)
...
**描述:** 获取/设置起始角度值(沿着管线路径方向顺时针旋转的角度)
...
**继承:** THING.BaseLine#groups

**重写:** THING.BaseLine#groups
...
**继承:** THING.BaseLine#groupPickedIds

**重写:** THING.BaseLine#groupPickedIds
...
**继承:** THING.BaseLine#groupsVisible

**重写:** THING.BaseLine#groupsVisible
...
**继承:** THING.BaseLine#closure

**重写:** THING.BaseLine#closure
...
**继承:** THING.BaseLine#uvScrollSpeed

**重写:** THING.BaseLine#uvScrollSpeed
...
**继承:** THING.BaseLine#uvScroll

**重写:** THING.BaseLine#uvScroll
...
**重写:** THING.BaseLine#autoAdjustPosition
...
**重写:** THING.BaseLine#isDynamicLoad
...
**重写:** THING.BaseLine#frustumCulled
...
**重写:** THING.BaseLine#localPosition
...
**重写:** THING.BaseLine#localRotation
...
**重写:** THING.BaseLine#localQuaternion
...
**重写:** THING.BaseLine#ignoreParentTransform
...
**重写:** THING.BaseLine#relationships
...
**继承:** THING.BaseLine#setUv

**重写:** THING.BaseLine#setUv
...
**继承:** THING.BaseLine#getUv

**重写:** THING.BaseLine#getUv
...
**重写:** THING.BaseLine#getFrustumCulled
...
**重写:** THING.BaseLine#setFrustumCulled
...
**重写:** THING.BaseLine#waitForComplete
...
**重写:** THING.BaseLine#loadResource
...
**重写:** THING.BaseLine#unloadResource
...
**重写:** THING.BaseLine#getRenderOrder
...
**重写:** THING.BaseLine#setRenderOrder
...
**重写:** THING.BaseLine#makeInstancedDrawing
...
**重写:** THING.BaseLine#enableInstancing
...
**重写:** THING.BaseLine#disableInstancing
...
**重写:** THING.BaseLine#setInstancing
...
**重写:** THING.BaseLine#getInstancing
...
**重写:** THING.BaseLine#setInstancingColor
...
**重写:** THING.BaseLine#setInstancingClearOutColor
...
**重写:** THING.BaseLine#getInstancingClearOutColor
...
**重写:** THING.BaseLine#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseLine#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseLine#setInstancingVisible
...
**重写:** THING.BaseLine#getInstancingVisible
...
**重写:** THING.BaseLine#getInstancedCount
...
**重写:** THING.BaseLine#setInstancingMatrix
...
**重写:** THING.BaseLine#getInstancingMatrix
...
**重写:** THING.BaseLine#setInstancingAttribute
...
**重写:** THING.BaseLine#getInstancingAttribute
...
**重写:** THING.BaseLine#resumeMoving
...
**重写:** THING.BaseLine#movePathAsync
...
**重写:** THING.BaseLine#pauseScaling
...
**重写:** THING.BaseLine#resumeScaling
...
**重写:** THING.BaseLine#stopRotating
...
**重写:** THING.BaseLine#pauseRotating
...
**重写:** THING.BaseLine#resumeRotating
...
**重写:** THING.BaseLine#resumeFading
...
**重写:** THING.BaseLine#fadeOutAsync
...
**重写:** THING.BaseLine#resumeFlying
...
**重写:** THING.BaseLine#stopUVTransform
...
**重写:** THING.BaseLine#pauseUVTransform
...
**重写:** THING.BaseLine#resumeUVTransform
...
**重写:** THING.BaseLine#uvTransformTo
...
**重写:** THING.BaseLine#rotateOnAxis
...
**重写:** THING.BaseLine#localToWorld
...
**重写:** THING.BaseLine#worldToLocal
...
**重写:** THING.BaseLine#hasAttribute
...
**重写:** THING.BaseLine#getAttribute
...
**重写:** THING.BaseLine#setAttribute
...
**重写:** THING.BaseLine#setAttributes
...
**重写:** THING.BaseLine#queryByDTType
...
**重写:** THING.BaseLine#queryByUserData
...
**重写:** THING.BaseLine#queryByRegExp
...
**重写:** THING.BaseLine#addComponent
...
**重写:** THING.BaseLine#removeComponent
...
**重写:** THING.BaseLine#removeAllComponents
...
**重写:** THING.BaseLine#traverseComponentByType
...
**重写:** THING.BaseLine#getComponentByName
...
**重写:** THING.BaseLine#getComponentByType
...
**重写:** THING.BaseLine#getComponentsByType
...
**重写:** THING.BaseLine#getAllComponents
...
**重写:** THING.BaseLine#hasComponent
