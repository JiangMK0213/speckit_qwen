...
| param.dataSource | `Array.<GeoJSON>` | - | 是 | 图层数据源 |
| param.id | `String` | - | 是 | 图层 ID |
| param.name | `String` | - | 是 | 图层名称 |
...
| param.offsetHeightField | `String` | - | 是 | 离地高度字段 这里的离地高度是每一根线整体的离地高 |
| param.offsetHeightFactor | `Number` | `1` | 是 | 离地高度倍数 |
| param.groundHeightField | `String` | - | 是 | 地形高度字段 高度字段中的值应该对应线的每个点的高度 |
| param.groundHeightFactor | `Number` | `1` | 是 | 地形高度倍数 |
...
| param.style | `THING.EARTH.GeoLineStyle` | - | 是 | 图层样式 与创建FeatureLayer的样式一致 |
