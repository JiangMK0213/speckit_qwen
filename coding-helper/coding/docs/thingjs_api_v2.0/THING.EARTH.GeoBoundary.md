...
| param.heights | `Array.<Number>` | - | 是 | 线每个顶点抬高数组 数组长度与coordinates数组长度需一致 |
...
| param.extrudeHeight | `Number, Array.<Number>` | `100` | 是 | 围栏高度 支持数组 代表每个顶点对应的高度 |
...
| param.style | `THING.EARTH.GeoBoundaryStyle` | - | 否 | 样式效果 |
