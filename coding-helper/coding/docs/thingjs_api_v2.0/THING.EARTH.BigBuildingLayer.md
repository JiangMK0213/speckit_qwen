...
**继承:** [THING.EARTH.BigDataLayer](./THING.EARTH.BigDataLayer.md)
...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | - |
| param.id | `String` | - | 是 | 图层 ID |
| param.visible | `Boolean` | `true` | 是 | 显示/隐藏 |
| param.visibleLevel | `Array.<Number>` | - | 是 | 可见层级 默认全部级别可见 |
| param.renderOrder | `Number` | `0` | 是 | 渲染顺序 |
| param.complete | `function` | - | 是 | 图层创建完毕后的回调函数 |
| param.url | `String` | - | 是 | 图层数据源的url |
| param.style | `THING.EARTH.GeoBuildingStyle` | - | 是 | 图层样式 与创建FeatureLayer的样式一致 |
| param.extrudeFactor | `Number` | `1` | 是 | 建筑拔高放大倍数,与extrudeField配合使用，默认是1 |
| param.extrudeField | `String` | - | 是 | 建筑拔高字段 |
| param.extrudeHeight | `String` | - | 是 | 建筑拔高 优先级高于extrudeField |
| param.offsetHeight | `Number` | `0` | 是 | 离地高度 |
| param.offsetHeightField | `String` | - | 是 | 离地高度字段 |
| param.sync | `Boolean` | `false` | 是 | 是否同步创建 默认false 建筑默认采用异步方式创建 |
| param.dataSource | `GeoJSONFeatureCollection` | - | 否 | 数据源 目前只支持Polygon和MultiPolygon格式的geojson |
| param.usePickId | `Boolean` | `true` | 是 | 是否在创建顶点时写入pickId 用于单个对象的拾取 |
| param.useInVisibleIndices | `Boolean` | `true` | 是 | 是否在创建顶点时写入不可见对象索引，用于控制单个对象显隐,需要usePickId也为true |
| param.useDynamicExtrude | `Boolean` | `true` | 是 | 是否在创建顶点时是否将拔高和抬高信息写入，用于动态设置拔高相关参数 |
| param.useAllUV | `Boolean` | `true` | 是 | 是否使用多套uv，用户动态切换uv，如果是false，仅导出与初始化传入参数匹配的uv，不支持动态修改 |
| param.closeBottom | `Boolean` | `true` | 是 | 是否创建底面 |
...
**描述:** 是否使用动态拔高的开关 开启后可以动态修改抬高和拔高相关属性</br>如果没有动态修改的需求,初始化时可以设置为false,可以提升加载速度
...
**描述:** 获取/设置图层中对象的拔高 如果是根据字段拔高则返回undefined
...
**继承:** THING.EARTH.BigDataLayer#url

**重写:** THING.EARTH.BigDataLayer#url
...
**继承:** THING.EARTH.BigDataLayer#offsetHeight

**重写:** THING.EARTH.BigDataLayer#offsetHeight
...
**继承:** THING.EARTH.BigDataLayer#offsetHeightField

**重写:** THING.EARTH.BigDataLayer#offsetHeightField
...
**继承:** THING.EARTH.BigDataLayer#offsetHeightFactor

**重写:** THING.EARTH.BigDataLayer#offsetHeightFactor
...
**继承:** THING.EARTH.BigDataLayer#inVisibleIndices

**重写:** THING.EARTH.BigDataLayer#inVisibleIndices

**描述:** 设置/获取 隐藏对象索引数组 设置之后对应索引的对象会被隐藏 索引的值即对象对应的Feature在数据源中的索引初始化BigDataLayer时需设置useInVisibleIndices和usePickId为true
...
**继承:** THING.EARTH.BigDataLayer#geoObjectType

**重写:** THING.EARTH.BigDataLayer#geoObjectType
...
**继承:** THING.EARTH.BigDataLayer#useInVisibleIndices

**重写:** THING.EARTH.BigDataLayer#useInVisibleIndices

**描述:** 是否给attribute中添加单个对象显示使用的顶点数据
...
**继承:** THING.EARTH.BigDataLayer#usePickId

**重写:** THING.EARTH.BigDataLayer#usePickId

**描述:** 是否给attribute中添加pick使用的数据
...
**继承:** THING.EARTH.BigDataLayer#style

**重写:** THING.EARTH.BigDataLayer#style
...
**继承:** THING.EARTH.Layer#id

**重写:** THING.EARTH.BigDataLayer#id
...
**继承:** THING.EARTH.Layer#visible

**重写:** THING.EARTH.BigDataLayer#visible
...
**继承:** THING.EARTH.Layer#visibleLevel

**重写:** THING.EARTH.BigDataLayer#visibleLevel
...
**数据类型:** `LayerLoadStatus`

**继承:** THING.EARTH.Layer#loadStatus

**重写:** THING.EARTH.BigDataLayer#loadStatus
...
**重写:** THING.EARTH.BigDataLayer#helper
...
**重写:** THING.EARTH.BigDataLayer#lerp
...
**重写:** THING.EARTH.BigDataLayer#level
...
**重写:** THING.EARTH.BigDataLayer#collider
...
**重写:** THING.EARTH.BigDataLayer#name
...
**重写:** THING.EARTH.BigDataLayer#isDynamicLoad
...
**重写:** THING.EARTH.BigDataLayer#layerMask
...
**重写:** THING.EARTH.BigDataLayer#styleTag
...
**重写:** THING.EARTH.BigDataLayer#inherit
...
**重写:** THING.EARTH.BigDataLayer#pickable
...
**重写:** THING.EARTH.BigDataLayer#active
...
**重写:** THING.EARTH.BigDataLayer#frustumCulled
...
**重写:** THING.EARTH.BigDataLayer#keepSize
...
**重写:** THING.EARTH.BigDataLayer#pivot
...
**重写:** THING.EARTH.BigDataLayer#body
...
**重写:** THING.EARTH.BigDataLayer#renderOrder
...
**重写:** THING.EARTH.BigDataLayer#alwaysOnTop
...
**重写:** THING.EARTH.BigDataLayer#boundingBox
...
**重写:** THING.EARTH.BigDataLayer#orientedBox
...
**重写:** THING.EARTH.BigDataLayer#isFlying
...
**重写:** THING.EARTH.BigDataLayer#localPosition
...
**重写:** THING.EARTH.BigDataLayer#localAngles
...
**重写:** THING.EARTH.BigDataLayer#localRotation
...
**重写:** THING.EARTH.BigDataLayer#localQuaternion
...
**重写:** THING.EARTH.BigDataLayer#localScale
...
**重写:** THING.EARTH.BigDataLayer#position
...
**重写:** THING.EARTH.BigDataLayer#angles
...
**重写:** THING.EARTH.BigDataLayer#rotation
...
**重写:** THING.EARTH.BigDataLayer#quaternion
...
**重写:** THING.EARTH.BigDataLayer#scale
...
**重写:** THING.EARTH.BigDataLayer#ignoreParentTransform
...
**重写:** THING.EARTH.BigDataLayer#app
...
**重写:** THING.EARTH.BigDataLayer#type
...
**重写:** THING.EARTH.BigDataLayer#dtType
...
**重写:** THING.EARTH.BigDataLayer#uuid
...
**重写:** THING.EARTH.BigDataLayer#tags
...
**重写:** THING.EARTH.BigDataLayer#userData
...
**重写:** THING.EARTH.BigDataLayer#destroyable
...
**重写:** THING.EARTH.BigDataLayer#queryable
...
**重写:** THING.EARTH.BigDataLayer#parent
...
**重写:** THING.EARTH.BigDataLayer#relationships
...
**重写:** THING.EARTH.BigDataLayer#parents
...
**重写:** THING.EARTH.BigDataLayer#brothers
...
**重写:** THING.EARTH.BigDataLayer#children
...
**重写:** THING.EARTH.BigDataLayer#components
...
**继承:** THING.EARTH.BigDataLayer#updateStyle

**重写:** THING.EARTH.BigDataLayer#updateStyle

**描述:** 更新样式效果，即改变设置前后两种样式的差异部分(增量更新)
...
|------|------|-------------|
| `style` | `Object` | 待更新样式 |
| `forceRebuildMesh` | `Boolean` | 是否强制重新创建Mesh 如果不传,默认会根据传入的style和当前style来决定是否重新创建 |
...
**继承:** THING.EARTH.BigDataLayer#setStyle

**重写:** THING.EARTH.BigDataLayer#setStyle

**描述:** 设置样式效果，需传入完整的样式对象，可替换原样式效果(全量更新)
...
**继承:** THING.EARTH.BigDataLayer#update

**重写:** THING.EARTH.BigDataLayer#update

**描述:** 全量更新BigDataLayer的属性 包含离地高,抬高,userData,style等参数
...
**继承:** THING.EARTH.BigDataLayer#getExtent

**重写:** THING.EARTH.BigDataLayer#getExtent
...
**继承:** THING.EARTH.Layer#hide

**重写:** THING.EARTH.BigDataLayer#hide
...
**继承:** THING.EARTH.Layer#show

**重写:** THING.EARTH.BigDataLayer#show
...
**继承:** THING.EARTH.Layer#startScanning

**重写:** THING.EARTH.BigDataLayer#startScanning

**描述:** 开始扫光 注意 TileLayer,Tile3DLayer不支持扫光
...
|------|------|-------------|
| `params` | `Object` | 扫光参数 |
| `params.type` | `THING.EARTH.ScanningType` | 扫描类型 |
| `params.mode` | `THING.EARTH.ScanningMode` | 扫描模式 |
| `params.angle` | `Number` | 扫描角度，默认为0 |
| `params.speed` | `number` | 扫描速度，默认为1。 |
| `params.color` | `Array` | 扫描颜色，默认为白色。 |
| `params.opacity` | `number` | 扫描透明度，默认为1。 |
| `params.blending` | `boolean` | 是否启用混合，默认为true。 |
| `params.effect` | `boolean` | 是否启用发光，默认为false。 |
...
**继承:** THING.EARTH.Layer#stopScanning

**重写:** THING.EARTH.BigDataLayer#stopScanning
...
**继承:** THING.EARTH.Layer#pauseScanning

**重写:** THING.EARTH.BigDataLayer#pauseScanning
...
**继承:** THING.EARTH.Layer#resumeScanning

**重写:** THING.EARTH.BigDataLayer#resumeScanning
...
**继承:** THING.EARTH.Layer#destroyScanning

**重写:** THING.EARTH.BigDataLayer#destroyScanning
...
**重写:** THING.EARTH.BigDataLayer#getVisible
...
**重写:** THING.EARTH.BigDataLayer#setVisible
...
**重写:** THING.EARTH.BigDataLayer#setPickable
...
**重写:** THING.EARTH.BigDataLayer#getFrustumCulled
...
**重写:** THING.EARTH.BigDataLayer#setFrustumCulled
...
**重写:** THING.EARTH.BigDataLayer#distanceTo
...
**重写:** THING.EARTH.BigDataLayer#add
...
**重写:** THING.EARTH.BigDataLayer#promoteNode
...
**重写:** THING.EARTH.BigDataLayer#raycast
...
**重写:** THING.EARTH.BigDataLayer#clone
...
**重写:** THING.EARTH.BigDataLayer#waitForComplete
...
**重写:** THING.EARTH.BigDataLayer#loadResource
...
**重写:** THING.EARTH.BigDataLayer#unloadResource
...
**重写:** THING.EARTH.BigDataLayer#copy
...
**重写:** THING.EARTH.BigDataLayer#getRenderOrder
...
**重写:** THING.EARTH.BigDataLayer#setRenderOrder
...
**重写:** THING.EARTH.BigDataLayer#makeInstancedDrawing
...
**重写:** THING.EARTH.BigDataLayer#enableInstancing
...
**重写:** THING.EARTH.BigDataLayer#disableInstancing
...
**重写:** THING.EARTH.BigDataLayer#setInstancing
...
**重写:** THING.EARTH.BigDataLayer#getInstancing
...
**重写:** THING.EARTH.BigDataLayer#setInstancingColor
...
**重写:** THING.EARTH.BigDataLayer#setInstancingClearOutColor
...
**重写:** THING.EARTH.BigDataLayer#getInstancingClearOutColor
...
**重写:** THING.EARTH.BigDataLayer#setInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.BigDataLayer#getInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.BigDataLayer#setInstancingVisible
...
**重写:** THING.EARTH.BigDataLayer#getInstancingVisible
...
**重写:** THING.EARTH.BigDataLayer#getInstancedCount
...
**重写:** THING.EARTH.BigDataLayer#setInstancingMatrix
...
**重写:** THING.EARTH.BigDataLayer#getInstancingMatrix
...
**重写:** THING.EARTH.BigDataLayer#setInstancingAttribute
...
**重写:** THING.EARTH.BigDataLayer#getInstancingAttribute
...
**重写:** THING.EARTH.BigDataLayer#getAABB
...
**重写:** THING.EARTH.BigDataLayer#getOBB
...
**重写:** THING.EARTH.BigDataLayer#stopMoving
...
**重写:** THING.EARTH.BigDataLayer#pauseMoving
...
**重写:** THING.EARTH.BigDataLayer#resumeMoving
...
**重写:** THING.EARTH.BigDataLayer#moveTo
...
**重写:** THING.EARTH.BigDataLayer#movePath
...
**重写:** THING.EARTH.BigDataLayer#movePathAsync
...
**重写:** THING.EARTH.BigDataLayer#stopScaling
...
**重写:** THING.EARTH.BigDataLayer#pauseScaling
...
**重写:** THING.EARTH.BigDataLayer#resumeScaling
...
**重写:** THING.EARTH.BigDataLayer#scaleTo
...
**重写:** THING.EARTH.BigDataLayer#stopRotating
...
**重写:** THING.EARTH.BigDataLayer#pauseRotating
...
**重写:** THING.EARTH.BigDataLayer#resumeRotating
...
**重写:** THING.EARTH.BigDataLayer#rotateTo
...
**重写:** THING.EARTH.BigDataLayer#stopFading
...
**重写:** THING.EARTH.BigDataLayer#pauseFading
...
**重写:** THING.EARTH.BigDataLayer#resumeFading
...
**重写:** THING.EARTH.BigDataLayer#fadeIn
...
**重写:** THING.EARTH.BigDataLayer#fadeOut
...
**重写:** THING.EARTH.BigDataLayer#fadeInAsync
...
**重写:** THING.EARTH.BigDataLayer#fadeOutAsync
...
**重写:** THING.EARTH.BigDataLayer#stopFlying
...
**重写:** THING.EARTH.BigDataLayer#pauseFlying
...
**重写:** THING.EARTH.BigDataLayer#resumeFlying
...
**重写:** THING.EARTH.BigDataLayer#flyTo
...
**重写:** THING.EARTH.BigDataLayer#fit
...
**重写:** THING.EARTH.BigDataLayer#stopUVTransform
...
**重写:** THING.EARTH.BigDataLayer#pauseUVTransform
...
**重写:** THING.EARTH.BigDataLayer#resumeUVTransform
...
**重写:** THING.EARTH.BigDataLayer#uvTransformTo
...
**重写:** THING.EARTH.BigDataLayer#rotate
...
**重写:** THING.EARTH.BigDataLayer#rotateOnAxis
...
**重写:** THING.EARTH.BigDataLayer#rotateX
...
**重写:** THING.EARTH.BigDataLayer#rotateY
...
**重写:** THING.EARTH.BigDataLayer#rotateZ
...
**重写:** THING.EARTH.BigDataLayer#translateX
...
**重写:** THING.EARTH.BigDataLayer#translateY
...
**重写:** THING.EARTH.BigDataLayer#translateZ
...
**重写:** THING.EARTH.BigDataLayer#translate
...
**重写:** THING.EARTH.BigDataLayer#lookAt
...
**重写:** THING.EARTH.BigDataLayer#worldToSelf
...
**重写:** THING.EARTH.BigDataLayer#selfToWorld
...
**重写:** THING.EARTH.BigDataLayer#localToWorld
...
**重写:** THING.EARTH.BigDataLayer#worldToLocal
...
**重写:** THING.EARTH.BigDataLayer#hasAttribute
...
**重写:** THING.EARTH.BigDataLayer#getAttribute
...
**重写:** THING.EARTH.BigDataLayer#setAttribute
...
**重写:** THING.EARTH.BigDataLayer#setAttributes
...
**重写:** THING.EARTH.BigDataLayer#on
...
**重写:** THING.EARTH.BigDataLayer#once
...
**重写:** THING.EARTH.BigDataLayer#off
...
**重写:** THING.EARTH.BigDataLayer#pauseEvent
...
**重写:** THING.EARTH.BigDataLayer#resumeEvent
...
**重写:** THING.EARTH.BigDataLayer#trigger
...
**重写:** THING.EARTH.BigDataLayer#invoke
...
**重写:** THING.EARTH.BigDataLayer#remove
...
**重写:** THING.EARTH.BigDataLayer#traverse
...
**重写:** THING.EARTH.BigDataLayer#query
...
**重写:** THING.EARTH.BigDataLayer#queryAll
...
**重写:** THING.EARTH.BigDataLayer#queryByName
...
**重写:** THING.EARTH.BigDataLayer#queryById
...
**重写:** THING.EARTH.BigDataLayer#queryByTags
...
**重写:** THING.EARTH.BigDataLayer#queryByUUID
...
**重写:** THING.EARTH.BigDataLayer#queryByType
...
**重写:** THING.EARTH.BigDataLayer#queryByDTType
...
**重写:** THING.EARTH.BigDataLayer#queryByUserData
...
**重写:** THING.EARTH.BigDataLayer#queryByRegExp
...
**重写:** THING.EARTH.BigDataLayer#addComponent
...
**重写:** THING.EARTH.BigDataLayer#removeComponent
...
**重写:** THING.EARTH.BigDataLayer#removeAllComponents
...
**重写:** THING.EARTH.BigDataLayer#traverseComponentByType
...
**重写:** THING.EARTH.BigDataLayer#getComponentByName
...
**重写:** THING.EARTH.BigDataLayer#getComponentByType
...
**重写:** THING.EARTH.BigDataLayer#getComponentsByType
...
**重写:** THING.EARTH.BigDataLayer#getAllComponents
...
**重写:** THING.EARTH.BigDataLayer#hasComponent
