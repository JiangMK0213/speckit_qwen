...
**继承:** [THING.EARTH.ThingLayer](./THING.EARTH.ThingLayer.md)
...
| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | 参数列表 除了整体参数(data,geoObjectType,idField等) 与创建单个GeoObject的参数一致 |
| param.url | `String` | - | 是 | 数据源url |
| param.data | `GeoJSONFeatureCollection` | - | 是 | 数据源 |
| param.geoObjectType | `String` | - | 否 | GeoObject的类型 例如 GeoPoint GeoLine GeoPolyon GeoBuilding GeoPolygon等 |
| param.style | `THING.EARTH.GeoBaseStyle` | - | 否 | 图层样式 |
| param.extrudeHeight | `Number` | - | 是 | 拔高高度 单位米 优先级高于extrudeField geoObjectType为GeoPolygon GeoBuilding GeoBoundary时生效 |
| param.extrudeField | `Number` | - | 是 | 拔高字段 geoObjectType为GeoPolygon GeoBuilding时生效 |
| param.extrudeFactor | `Number` | `1` | 是 | 拔高倍数 与拔高倍数配合使用 geoObjectType为GeoPolygon GeoBuilding时生效 |
| param.offsetHeight | `Number` | `0` | 是 | 离地高度 单位米 默认0 |
| param.offsetHeightField | `String` | - | 是 | 离地高度字段 |
| param.offsetHeightFactor | `Number` | `1` | 是 | 离地高度倍数 默认1 |
| param.label | `GeoLabel` | - | 是 | 标记 |
| param.infoWindow | `InfoWindow` | - | 是 | 信息框 |
| param.idField | `String` | `'id'` | 是 | ID字段 是指从属性中取该字段的值作为GeoObject的id值 |
| param.renderOrder | `Number` | `0` | 是 | 渲染顺序 |
| param.azimuth | `Number` | `0` | 是 | 方位角 geoObjectType为GeoPoint时生效 |
| param.sync | `Boolean` | `false` | 是 | 是否不开启Worker,以同步的方式创建子对象 适用于贴地线和贴地面 |
| param.pivot | `Array.<Number>` | - | 是 | 轴心点 geoObjectType为GeoPoint时生效 |
| param.useMercatorUV | `Boolean` | - | 是 | GeoPolygon/GeoWater时 是否用墨卡托投影计算uv |
| param.arcType | `THING.EARTH.ArcType` | - | 是 | GeoPolygon/GeoWater时 创建多边形的绘制方式 |
| param.granularity | `Number` | `Math.PI/180` | 是 | GeoPolygon/GeoWater时 多边形三角化的精度 值越小精度越高 |
...
**数据类型:** `THING.EARTH.ArcType`

**描述:** 获取/设置 多边形边界的绘制方式 详见ArcType
...
**重写:** THING.EARTH.ThingLayer#pivot

**描述:** 获取/设置相对于本地坐标系下的轴心点信息，仅geoObjectType为GeoPoint时生效。注: 轴心点参考原点为: [left, bottom, back]
...
**描述:** 获取/设置方位角，仅geoObjectType为GeoPoint时生效。注: 方位角0度代表朝北
...
**描述:** id字段 是指从属性中取该字段的值作为GeoObject的id值
...
**描述:** name字段 是指从属性中取该字段的值作为GeoObject的name值
...
**重写:** THING.EARTH.ThingLayer#style
...
**描述:** 获取/设置geoObjectType为GeoPolygon/GeoWater的三角面精度 值越小精度越高
...
**数据类型:** `Array.<GeoJSON>, GeoJSONFeatureCollection`

**继承:** THING.EARTH.ThingLayer#data

**重写:** THING.EARTH.ThingLayer#data
...
**继承:** THING.EARTH.ThingLayer#url

**重写:** THING.EARTH.ThingLayer#url
...
**重写:** THING.EARTH.ThingLayer#visible
...
**继承:** THING.EARTH.Layer#offsetHeight

**重写:** THING.EARTH.ThingLayer#offsetHeight
...
**重写:** THING.EARTH.ThingLayer#visibleLevel
...
**重写:** THING.EARTH.ThingLayer#loadStatus
...
**重写:** THING.EARTH.ThingLayer#helper
...
**重写:** THING.EARTH.ThingLayer#lerp
...
**重写:** THING.EARTH.ThingLayer#level
...
**重写:** THING.EARTH.ThingLayer#collider
...
**重写:** THING.EARTH.ThingLayer#name
...
**重写:** THING.EARTH.ThingLayer#isDynamicLoad
...
**重写:** THING.EARTH.ThingLayer#layerMask
...
**重写:** THING.EARTH.ThingLayer#styleTag
...
**重写:** THING.EARTH.ThingLayer#inherit
...
**重写:** THING.EARTH.ThingLayer#pickable
...
**重写:** THING.EARTH.ThingLayer#active
...
**重写:** THING.EARTH.ThingLayer#frustumCulled
...
**重写:** THING.EARTH.ThingLayer#keepSize
...
**重写:** THING.EARTH.ThingLayer#body
...
**重写:** THING.EARTH.ThingLayer#renderOrder
...
**重写:** THING.EARTH.ThingLayer#alwaysOnTop
...
**重写:** THING.EARTH.ThingLayer#boundingBox
...
**重写:** THING.EARTH.ThingLayer#orientedBox
...
**重写:** THING.EARTH.ThingLayer#isFlying
...
**重写:** THING.EARTH.ThingLayer#localPosition
...
**重写:** THING.EARTH.ThingLayer#localAngles
...
**重写:** THING.EARTH.ThingLayer#localRotation
...
**重写:** THING.EARTH.ThingLayer#localQuaternion
...
**重写:** THING.EARTH.ThingLayer#localScale
...
**重写:** THING.EARTH.ThingLayer#position
...
**重写:** THING.EARTH.ThingLayer#angles
...
**重写:** THING.EARTH.ThingLayer#rotation
...
**重写:** THING.EARTH.ThingLayer#quaternion
...
**重写:** THING.EARTH.ThingLayer#scale
...
**重写:** THING.EARTH.ThingLayer#ignoreParentTransform
...
**重写:** THING.EARTH.ThingLayer#type
...
**重写:** THING.EARTH.ThingLayer#dtType
...
**重写:** THING.EARTH.ThingLayer#uuid
...
**重写:** THING.EARTH.ThingLayer#tags
...
**重写:** THING.EARTH.ThingLayer#userData
...
**重写:** THING.EARTH.ThingLayer#destroyable
...
**重写:** THING.EARTH.ThingLayer#queryable
...
**重写:** THING.EARTH.ThingLayer#parent
...
**重写:** THING.EARTH.ThingLayer#relationships
...
**重写:** THING.EARTH.ThingLayer#parents
...
**重写:** THING.EARTH.ThingLayer#brothers
...
**重写:** THING.EARTH.ThingLayer#children
...
**重写:** THING.EARTH.ThingLayer#components
...
**描述:** 全量更新FeatureLayer的属性 会全量更新样式(param.style)

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `param` | `Object` | FeatureLayer的属性 需传入完整的参数 |
| `shareMaterial` | `Boolean` | 是否共用材质 |
...
**重写:** THING.EARTH.ThingLayer#setStyle

**描述:** 全量更新FeatureLayer的style
...
**描述:** 该方法可以重新设置图层中对象的抬高高度

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `height` | `Number` | 重新设置的抬高高度 |
| `field` | `String` | 重新设置的抬高字段 |
| `factor` | `Number` | 重新设置的抬高倍数 |
...
**继承:** THING.EARTH.ThingLayer#addMany

**重写:** THING.EARTH.ThingLayer#addMany
...
**继承:** THING.EARTH.ThingLayer#add

**重写:** THING.EARTH.ThingLayer#add
...
**继承:** THING.EARTH.ThingLayer#remove

**重写:** THING.EARTH.ThingLayer#remove
...
**继承:** THING.EARTH.ThingLayer#removeMany

**重写:** THING.EARTH.ThingLayer#removeMany
...
**继承:** THING.EARTH.ThingLayer#removeAll

**重写:** THING.EARTH.ThingLayer#removeAll
...
**继承:** THING.EARTH.ThingLayer#removeById

**重写:** THING.EARTH.ThingLayer#removeById
...
**继承:** THING.EARTH.ThingLayer#getById

**重写:** THING.EARTH.ThingLayer#getById
...
**继承:** THING.EARTH.ThingLayer#getExtent

**重写:** THING.EARTH.ThingLayer#getExtent
...
**继承:** THING.EARTH.ThingLayer#getItems

**重写:** THING.EARTH.ThingLayer#getItems
...
**继承:** THING.EARTH.Layer#destroy

**重写:** THING.EARTH.ThingLayer#destroy
...
**重写:** THING.EARTH.ThingLayer#hide
...
**重写:** THING.EARTH.ThingLayer#show
...
**重写:** THING.EARTH.ThingLayer#startScanning
...
**重写:** THING.EARTH.ThingLayer#stopScanning
...
**重写:** THING.EARTH.ThingLayer#pauseScanning
...
**重写:** THING.EARTH.ThingLayer#resumeScanning
...
**重写:** THING.EARTH.ThingLayer#destroyScanning
...
**重写:** THING.EARTH.ThingLayer#getVisible
...
**重写:** THING.EARTH.ThingLayer#setVisible
...
**重写:** THING.EARTH.ThingLayer#setPickable
...
**重写:** THING.EARTH.ThingLayer#getFrustumCulled
...
**重写:** THING.EARTH.ThingLayer#setFrustumCulled
...
**重写:** THING.EARTH.ThingLayer#distanceTo
...
**重写:** THING.EARTH.ThingLayer#promoteNode
...
**重写:** THING.EARTH.ThingLayer#raycast
...
**重写:** THING.EARTH.ThingLayer#clone
...
**重写:** THING.EARTH.ThingLayer#waitForComplete
...
**重写:** THING.EARTH.ThingLayer#loadResource
...
**重写:** THING.EARTH.ThingLayer#unloadResource
...
**重写:** THING.EARTH.ThingLayer#copy
...
**重写:** THING.EARTH.ThingLayer#getRenderOrder
...
**重写:** THING.EARTH.ThingLayer#setRenderOrder
...
**重写:** THING.EARTH.ThingLayer#makeInstancedDrawing
...
**重写:** THING.EARTH.ThingLayer#enableInstancing
...
**重写:** THING.EARTH.ThingLayer#disableInstancing
...
**重写:** THING.EARTH.ThingLayer#setInstancing
...
**重写:** THING.EARTH.ThingLayer#getInstancing
...
**重写:** THING.EARTH.ThingLayer#setInstancingColor
...
**重写:** THING.EARTH.ThingLayer#setInstancingClearOutColor
...
**重写:** THING.EARTH.ThingLayer#getInstancingClearOutColor
...
**重写:** THING.EARTH.ThingLayer#setInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.ThingLayer#getInstancingDiffuseUVTransform
...
**重写:** THING.EARTH.ThingLayer#setInstancingVisible
...
**重写:** THING.EARTH.ThingLayer#getInstancingVisible
...
**重写:** THING.EARTH.ThingLayer#getInstancedCount
...
**重写:** THING.EARTH.ThingLayer#setInstancingMatrix
...
**重写:** THING.EARTH.ThingLayer#getInstancingMatrix
...
**重写:** THING.EARTH.ThingLayer#setInstancingAttribute
...
**重写:** THING.EARTH.ThingLayer#getInstancingAttribute
...
**重写:** THING.EARTH.ThingLayer#getAABB
...
**重写:** THING.EARTH.ThingLayer#getOBB
...
**重写:** THING.EARTH.ThingLayer#stopMoving
...
**重写:** THING.EARTH.ThingLayer#pauseMoving
...
**重写:** THING.EARTH.ThingLayer#resumeMoving
...
**重写:** THING.EARTH.ThingLayer#moveTo
...
**重写:** THING.EARTH.ThingLayer#movePath
...
**重写:** THING.EARTH.ThingLayer#movePathAsync
...
**重写:** THING.EARTH.ThingLayer#stopScaling
...
**重写:** THING.EARTH.ThingLayer#pauseScaling
...
**重写:** THING.EARTH.ThingLayer#resumeScaling
...
**重写:** THING.EARTH.ThingLayer#scaleTo
...
**重写:** THING.EARTH.ThingLayer#stopRotating
...
**重写:** THING.EARTH.ThingLayer#pauseRotating
...
**重写:** THING.EARTH.ThingLayer#resumeRotating
...
**重写:** THING.EARTH.ThingLayer#rotateTo
...
**重写:** THING.EARTH.ThingLayer#stopFading
...
**重写:** THING.EARTH.ThingLayer#pauseFading
...
**重写:** THING.EARTH.ThingLayer#resumeFading
...
**重写:** THING.EARTH.ThingLayer#fadeIn
...
**重写:** THING.EARTH.ThingLayer#fadeOut
...
**重写:** THING.EARTH.ThingLayer#fadeInAsync
...
**重写:** THING.EARTH.ThingLayer#fadeOutAsync
...
**重写:** THING.EARTH.ThingLayer#stopFlying
...
**重写:** THING.EARTH.ThingLayer#pauseFlying
...
**重写:** THING.EARTH.ThingLayer#resumeFlying
...
**重写:** THING.EARTH.ThingLayer#flyTo
...
**重写:** THING.EARTH.ThingLayer#stopUVTransform
...
**重写:** THING.EARTH.ThingLayer#pauseUVTransform
...
**重写:** THING.EARTH.ThingLayer#resumeUVTransform
...
**重写:** THING.EARTH.ThingLayer#uvTransformTo
...
**重写:** THING.EARTH.ThingLayer#rotate
...
**重写:** THING.EARTH.ThingLayer#rotateOnAxis
...
**重写:** THING.EARTH.ThingLayer#rotateX
...
**重写:** THING.EARTH.ThingLayer#rotateY
...
**重写:** THING.EARTH.ThingLayer#rotateZ
...
**重写:** THING.EARTH.ThingLayer#translateX
...
**重写:** THING.EARTH.ThingLayer#translateY
...
**重写:** THING.EARTH.ThingLayer#translateZ
...
**重写:** THING.EARTH.ThingLayer#translate
...
**重写:** THING.EARTH.ThingLayer#lookAt
...
**重写:** THING.EARTH.ThingLayer#worldToSelf
...
**重写:** THING.EARTH.ThingLayer#selfToWorld
...
**重写:** THING.EARTH.ThingLayer#localToWorld
...
**重写:** THING.EARTH.ThingLayer#worldToLocal
...
**重写:** THING.EARTH.ThingLayer#hasAttribute
...
**重写:** THING.EARTH.ThingLayer#getAttribute
...
**重写:** THING.EARTH.ThingLayer#setAttribute
...
**重写:** THING.EARTH.ThingLayer#setAttributes
...
**重写:** THING.EARTH.ThingLayer#once
...
**重写:** THING.EARTH.ThingLayer#pauseEvent
...
**重写:** THING.EARTH.ThingLayer#resumeEvent
...
**重写:** THING.EARTH.ThingLayer#trigger
...
**重写:** THING.EARTH.ThingLayer#invoke
...
**重写:** THING.EARTH.ThingLayer#traverse
...
**重写:** THING.EARTH.ThingLayer#query
...
**重写:** THING.EARTH.ThingLayer#queryAll
...
**重写:** THING.EARTH.ThingLayer#queryByName
...
**重写:** THING.EARTH.ThingLayer#queryById
...
**重写:** THING.EARTH.ThingLayer#queryByTags
...
**重写:** THING.EARTH.ThingLayer#queryByUUID
...
**重写:** THING.EARTH.ThingLayer#queryByType
...
**重写:** THING.EARTH.ThingLayer#queryByDTType
...
**重写:** THING.EARTH.ThingLayer#queryByUserData
...
**重写:** THING.EARTH.ThingLayer#queryByRegExp
...
**重写:** THING.EARTH.ThingLayer#addComponent
...
**重写:** THING.EARTH.ThingLayer#removeComponent
...
**重写:** THING.EARTH.ThingLayer#removeAllComponents
...
**重写:** THING.EARTH.ThingLayer#traverseComponentByType
...
**重写:** THING.EARTH.ThingLayer#getComponentByName
...
**重写:** THING.EARTH.ThingLayer#getComponentByType
...
**重写:** THING.EARTH.ThingLayer#getComponentsByType
...
**重写:** THING.EARTH.ThingLayer#getAllComponents
...
**重写:** THING.EARTH.ThingLayer#hasComponent
