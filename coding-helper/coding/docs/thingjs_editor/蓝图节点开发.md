...
```javascript
class BPTest extends THING.BLUEPRINT.BaseNode {
  static config = {}
...
![wizard](https://pan.uino.cn/files/image/2024/9/8fd02b4906e856c386c1f8f96c192b5a.png)
 ...
 * @path 'custom'
 */
export class BPMyDelay extends THING.BLUEPRINT.BaseNode3D {
  static config = {
    // 节点名称
    name: 'BPMyDelay',
    // 输入连接点
