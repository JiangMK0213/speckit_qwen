...
| 名称 | 类型 | 默认值 | 可选 | 描述 |
|------|------|--------|-------------|--------|
| width | `number` | `1.0` | 是 | 宽度，单位为米，默认为1 |
| height | `number` | `1.0` | 是 | 高度，单位为米，默认为1 |
| param | `object` | - | 是 | 初始参数。与BaseObject3D的初始参数相同，例如position、angles等 |
