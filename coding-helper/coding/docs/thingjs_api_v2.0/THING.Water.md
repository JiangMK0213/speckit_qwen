...
**继承:** [THING.BasePlanePoints](./THING.BasePlanePoints.md)
...
|------|------|--------|-------------|--------|
| param | `object` | - | 否 | - |
| param.points | `Array.<Array.<number>>` | - | 是 | 世界坐标系下(3D)区域外轮廓坐标 |
| param.holes | `Array.<Array.<Array.<number>>>` | - | 是 | 世界坐标系下(3D)区域内空洞的坐标(支持多个空洞) |
| param.selfPoints | `Array.<Array.<number>>` | - | 是 | 自身坐标系下(3D)区域外轮廓坐标 |
| param.selfHoles | `Array.<Array.<Array.<number>>>` | - | 是 | 自身坐标系下(3D)区域空洞坐标 |
| param.selfPlanePoints | `Array.<Array.<number>>` | - | 是 | 自身平面坐标系下(2D)区域外轮廓坐标 |
| param.selfPlaneHoles | `Array.<Array.<Array.<number>>>` | - | 是 | 自身平面坐标系下(2D)区域空洞坐标 |
| param.flowSpeed | `Array.<number>` | `[0,0]` | 是 | 流速(数组,分别代表x,y方向的流速) |
| param.flowWeight | `number` | `0.5` | 是 | 波浪强度 |
| param.reflectDistortion | `number` | `2` | 是 | 反射变形系数 |
| param.noiseTimeScale | `number` | `1` | 是 | 水流动态效果(噪声系数) |
| param.style | `object` | - | 否 | 物体样式 |
...
**描述:** 获取/设置 水流动态效果(噪声系数,暂时还没看到效果是什么)
...
**数据类型:** `Array.<Array.<Array.<number>>>`

**继承:** THING.BasePlanePoints#selfPlaneHoles

**重写:** THING.BasePlanePoints#selfPlaneHoles

**描述:** 设置/获取 自身平面坐标系下(2D)区域空洞坐标
...
**继承:** THING.BasePlanePoints#selfHoles

**重写:** THING.BasePlanePoints#selfHoles

**描述:** 设置/获取 自身坐标系下(3D)区域空洞坐标
...
**继承:** THING.BasePlanePoints#holes

**重写:** THING.BasePlanePoints#holes

**描述:** 设置/获取 世界坐标系下(3D)区域空洞坐标
...
**继承:** THING.BasePlanePoints#selfPlanePoints

**重写:** THING.BasePlanePoints#selfPlanePoints

**描述:** 设置/获取 自身平面坐标系下(2D)区域外轮廓坐标
...
**继承:** THING.BasePlanePoints#area

**重写:** THING.BasePlanePoints#area

**描述:** 获取区域面积(计算中会减去洞的面积)
...
**继承:** THING.BasePlanePoints#perimeter

**重写:** THING.BasePlanePoints#perimeter
...
**继承:** THING.BasePlanePoints#labelPosition

**重写:** THING.BasePlanePoints#labelPosition

**描述:** 获取世界坐标系下区域的标注位置(一般是在区域中心)
...
**数据类型:** `Array.<Array.<number>>`

**继承:** THING.BasePlanePoints#outlinePoints

**重写:** THING.BasePlanePoints#outlinePoints

**描述:** 获取自身平面空间(2D)下区域外轮廓点位
...
**继承:** THING.BasePoints#number

**重写:** THING.BasePlanePoints#number
...
**继承:** THING.BasePoints#autoAdjustPosition

**重写:** THING.BasePlanePoints#autoAdjustPosition

**描述:** 是否自动调整点坐标。当坐标过大时，由于精度问题可能导致抖动，此时需要自动调整。
...
**继承:** THING.BasePoints#selfPoints

**重写:** THING.BasePlanePoints#selfPoints

**描述:** 获取/设置对象自身坐标系中的点坐标集合
...
**继承:** THING.BasePoints#points

**重写:** THING.BasePlanePoints#points

**描述:** 获取/设置世界坐标系中的点坐标集合
...
**继承:** THING.BasePoints#localPoints

**重写:** THING.BasePlanePoints#localPoints

**描述:** 获取/设置局部坐标系中的点坐标集合
...
**继承:** THING.BasePoints#length

**重写:** THING.BasePlanePoints#length
...
**重写:** THING.BasePlanePoints#helper
...
**重写:** THING.BasePlanePoints#level
...
**重写:** THING.BasePlanePoints#collider
...
**重写:** THING.BasePlanePoints#isDynamicLoad
...
**重写:** THING.BasePlanePoints#layerMask
...
**重写:** THING.BasePlanePoints#styleTag
...
**重写:** THING.BasePlanePoints#inherit
...
**重写:** THING.BasePlanePoints#visible
...
**重写:** THING.BasePlanePoints#pickable
...
**重写:** THING.BasePlanePoints#active
...
**重写:** THING.BasePlanePoints#frustumCulled
...
**重写:** THING.BasePlanePoints#keepSize
...
**重写:** THING.BasePlanePoints#pivot
...
**重写:** THING.BasePlanePoints#style
...
**重写:** THING.BasePlanePoints#renderOrder
...
**重写:** THING.BasePlanePoints#alwaysOnTop
...
**重写:** THING.BasePlanePoints#boundingBox
...
**重写:** THING.BasePlanePoints#orientedBox
...
**重写:** THING.BasePlanePoints#isFlying
...
**重写:** THING.BasePlanePoints#localPosition
...
**重写:** THING.BasePlanePoints#localAngles
...
**重写:** THING.BasePlanePoints#localRotation
...
**重写:** THING.BasePlanePoints#localQuaternion
...
**重写:** THING.BasePlanePoints#localScale
...
**重写:** THING.BasePlanePoints#position
...
**重写:** THING.BasePlanePoints#angles
...
**重写:** THING.BasePlanePoints#rotation
...
**重写:** THING.BasePlanePoints#quaternion
...
**重写:** THING.BasePlanePoints#scale
...
**重写:** THING.BasePlanePoints#ignoreParentTransform
...
**重写:** THING.BasePlanePoints#dtType
...
**重写:** THING.BasePlanePoints#userData
...
**重写:** THING.BasePlanePoints#destroyable
...
**重写:** THING.BasePlanePoints#queryable
...
**重写:** THING.BasePlanePoints#parent
...
**重写:** THING.BasePlanePoints#relationships
...
**重写:** THING.BasePlanePoints#parents
...
**重写:** THING.BasePlanePoints#brothers
...
**重写:** THING.BasePlanePoints#children
...
**重写:** THING.BasePlanePoints#components
...
**重写:** THING.BasePlanePoints#getVisible
...
**重写:** THING.BasePlanePoints#setVisible
...
**重写:** THING.BasePlanePoints#setPickable
...
**重写:** THING.BasePlanePoints#getFrustumCulled
...
**重写:** THING.BasePlanePoints#setFrustumCulled
...
**重写:** THING.BasePlanePoints#distanceTo
...
**重写:** THING.BasePlanePoints#promoteNode
...
**重写:** THING.BasePlanePoints#raycast
...
**重写:** THING.BasePlanePoints#setStyle
...
**重写:** THING.BasePlanePoints#clone
...
**重写:** THING.BasePlanePoints#waitForComplete
...
**重写:** THING.BasePlanePoints#loadResource
...
**重写:** THING.BasePlanePoints#unloadResource
...
**重写:** THING.BasePlanePoints#getRenderOrder
...
**重写:** THING.BasePlanePoints#setRenderOrder
...
**重写:** THING.BasePlanePoints#makeInstancedDrawing
...
**重写:** THING.BasePlanePoints#enableInstancing
...
**重写:** THING.BasePlanePoints#disableInstancing
...
**重写:** THING.BasePlanePoints#setInstancing
...
**重写:** THING.BasePlanePoints#getInstancing
...
**重写:** THING.BasePlanePoints#setInstancingColor
...
**重写:** THING.BasePlanePoints#setInstancingClearOutColor
...
**重写:** THING.BasePlanePoints#getInstancingClearOutColor
...
**重写:** THING.BasePlanePoints#setInstancingDiffuseUVTransform
...
**重写:** THING.BasePlanePoints#getInstancingDiffuseUVTransform
...
**重写:** THING.BasePlanePoints#setInstancingVisible
...
**重写:** THING.BasePlanePoints#getInstancingVisible
...
**重写:** THING.BasePlanePoints#getInstancedCount
...
**重写:** THING.BasePlanePoints#setInstancingMatrix
...
**重写:** THING.BasePlanePoints#getInstancingMatrix
...
**重写:** THING.BasePlanePoints#setInstancingAttribute
...
**重写:** THING.BasePlanePoints#getInstancingAttribute
...
**重写:** THING.BasePlanePoints#getAABB
...
**重写:** THING.BasePlanePoints#getOBB
...
**重写:** THING.BasePlanePoints#stopMoving
...
**重写:** THING.BasePlanePoints#pauseMoving
...
**重写:** THING.BasePlanePoints#resumeMoving
...
**重写:** THING.BasePlanePoints#moveTo
...
**重写:** THING.BasePlanePoints#movePath
...
**重写:** THING.BasePlanePoints#movePathAsync
...
**重写:** THING.BasePlanePoints#stopScaling
...
**重写:** THING.BasePlanePoints#pauseScaling
...
**重写:** THING.BasePlanePoints#resumeScaling
...
**重写:** THING.BasePlanePoints#scaleTo
...
**重写:** THING.BasePlanePoints#stopRotating
...
**重写:** THING.BasePlanePoints#pauseRotating
...
**重写:** THING.BasePlanePoints#resumeRotating
...
**重写:** THING.BasePlanePoints#rotateTo
...
**重写:** THING.BasePlanePoints#stopFading
...
**重写:** THING.BasePlanePoints#pauseFading
...
**重写:** THING.BasePlanePoints#resumeFading
...
**重写:** THING.BasePlanePoints#fadeIn
...
**重写:** THING.BasePlanePoints#fadeOut
...
**重写:** THING.BasePlanePoints#fadeInAsync
...
**重写:** THING.BasePlanePoints#fadeOutAsync
...
**重写:** THING.BasePlanePoints#stopFlying
...
**重写:** THING.BasePlanePoints#pauseFlying
...
**重写:** THING.BasePlanePoints#resumeFlying
...
**重写:** THING.BasePlanePoints#flyTo
...
**重写:** THING.BasePlanePoints#stopUVTransform
...
**重写:** THING.BasePlanePoints#pauseUVTransform
...
**重写:** THING.BasePlanePoints#resumeUVTransform
...
**重写:** THING.BasePlanePoints#uvTransformTo
...
**重写:** THING.BasePlanePoints#rotate
...
**重写:** THING.BasePlanePoints#rotateOnAxis
...
**重写:** THING.BasePlanePoints#rotateX
...
**重写:** THING.BasePlanePoints#rotateY
...
**重写:** THING.BasePlanePoints#rotateZ
...
**重写:** THING.BasePlanePoints#translateX
...
**重写:** THING.BasePlanePoints#translateY
...
**重写:** THING.BasePlanePoints#translateZ
...
**重写:** THING.BasePlanePoints#translate
...
**重写:** THING.BasePlanePoints#lookAt
...
**重写:** THING.BasePlanePoints#worldToSelf
...
**重写:** THING.BasePlanePoints#selfToWorld
...
**重写:** THING.BasePlanePoints#localToWorld
...
**重写:** THING.BasePlanePoints#worldToLocal
...
**重写:** THING.BasePlanePoints#hasAttribute
...
**重写:** THING.BasePlanePoints#getAttribute
...
**重写:** THING.BasePlanePoints#setAttribute
...
**重写:** THING.BasePlanePoints#setAttributes
...
**重写:** THING.BasePlanePoints#destroy
...
**重写:** THING.BasePlanePoints#pauseEvent
...
**重写:** THING.BasePlanePoints#resumeEvent
...
**重写:** THING.BasePlanePoints#trigger
...
**重写:** THING.BasePlanePoints#invoke
...
**重写:** THING.BasePlanePoints#remove
...
**重写:** THING.BasePlanePoints#traverse
...
**重写:** THING.BasePlanePoints#query
...
**重写:** THING.BasePlanePoints#queryAll
...
**重写:** THING.BasePlanePoints#queryByName
...
**重写:** THING.BasePlanePoints#queryById
...
**重写:** THING.BasePlanePoints#queryByTags
...
**重写:** THING.BasePlanePoints#queryByUUID
...
**重写:** THING.BasePlanePoints#queryByType
...
**重写:** THING.BasePlanePoints#queryByDTType
...
**重写:** THING.BasePlanePoints#queryByUserData
...
**重写:** THING.BasePlanePoints#queryByRegExp
...
**重写:** THING.BasePlanePoints#addComponent
...
**重写:** THING.BasePlanePoints#removeComponent
...
**重写:** THING.BasePlanePoints#removeAllComponents
...
**重写:** THING.BasePlanePoints#traverseComponentByType
...
**重写:** THING.BasePlanePoints#getComponentByName
...
**重写:** THING.BasePlanePoints#getComponentByType
...
**重写:** THING.BasePlanePoints#getComponentsByType
...
**重写:** THING.BasePlanePoints#getAllComponents
...
**重写:** THING.BasePlanePoints#hasComponent
