...
| param.data | `object` | - | 否 | 存放模型的顶点信息，包括顶点位置(position)、法向量(normal)、贴图坐标(uv)、索引(index)等 |
| param.material | `object` | - | 否 | 材质属性 |
...
**描述:** 设置顶点位置信息 当 geometry 仅被当前 Mesh 引用时，使用此接口设置 Mesh 顶点。
...
**描述:** 设置顶点贴图坐标信息 当 geometry 仅被当前 Mesh 引用时，使用此接口设置 UV。
...
**描述:** 设置顶点法线信息 当 geometry 仅被当前 Mesh 引用时，使用此接口设置法线。
