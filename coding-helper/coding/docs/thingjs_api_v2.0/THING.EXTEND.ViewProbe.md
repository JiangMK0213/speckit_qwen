...
**继承:** [THING.BaseTickableObject3D](./THING.BaseTickableObject3D.md)
...
|------|------|--------|-------------|--------|
| param | `object` | - | 否 | 选项 |
| param.fov | `number` | - | 是 | 视锥体的视场角值 |
| param.aspect | `number` | - | 是 | 视锥体的宽高比值 |
| param.near | `number` | - | 是 | 视锥体的近平面值 |
| param.far | `number` | - | 是 | 视锥体的远平面值 |
| param.outerColor | `number, string, Array` | - | 是 | 轮廓线颜色 |
| param.innerScanning | `boolean` | - | 是 | 是否生成扫描平面 |
| param.coneScanning | `boolean` | - | 是 | 是否生成扫描锥体 |
| param.scanningNum | `Array` | - | 是 | 扫描区域的射线数量，扫描区域的数量 |
| param.innerPlaneColor | `number, string, Array` | - | 是 | 扫描面颜色 |
| param.innerPlaneOpacity | `number` | - | 是 | 扫描面透明度 |
...
**重写:** THING.BaseTickableObject3D#helper
...
**重写:** THING.BaseTickableObject3D#lerp
...
**重写:** THING.BaseTickableObject3D#level
...
**重写:** THING.BaseTickableObject3D#collider
...
**重写:** THING.BaseTickableObject3D#name
...
**重写:** THING.BaseTickableObject3D#isDynamicLoad
...
**重写:** THING.BaseTickableObject3D#layerMask
...
**重写:** THING.BaseTickableObject3D#styleTag
...
**重写:** THING.BaseTickableObject3D#inherit
...
**重写:** THING.BaseTickableObject3D#visible
...
**重写:** THING.BaseTickableObject3D#pickable
...
**重写:** THING.BaseTickableObject3D#active
...
**重写:** THING.BaseTickableObject3D#frustumCulled
...
**重写:** THING.BaseTickableObject3D#keepSize
...
**重写:** THING.BaseTickableObject3D#pivot
...
**重写:** THING.BaseTickableObject3D#style
...
**重写:** THING.BaseTickableObject3D#body
...
**重写:** THING.BaseTickableObject3D#renderOrder
...
**重写:** THING.BaseTickableObject3D#alwaysOnTop
...
**重写:** THING.BaseTickableObject3D#boundingBox
...
**重写:** THING.BaseTickableObject3D#orientedBox
...
**重写:** THING.BaseTickableObject3D#isFlying
...
**重写:** THING.BaseTickableObject3D#localPosition
...
**重写:** THING.BaseTickableObject3D#localAngles
...
**重写:** THING.BaseTickableObject3D#localRotation
...
**重写:** THING.BaseTickableObject3D#localQuaternion
...
**重写:** THING.BaseTickableObject3D#localScale
...
**重写:** THING.BaseTickableObject3D#position
...
**重写:** THING.BaseTickableObject3D#angles
...
**重写:** THING.BaseTickableObject3D#rotation
...
**重写:** THING.BaseTickableObject3D#quaternion
...
**重写:** THING.BaseTickableObject3D#scale
...
**重写:** THING.BaseTickableObject3D#ignoreParentTransform
...
**重写:** THING.BaseTickableObject3D#app
...
**重写:** THING.BaseTickableObject3D#type
...
**重写:** THING.BaseTickableObject3D#dtType
...
**重写:** THING.BaseTickableObject3D#id
...
**重写:** THING.BaseTickableObject3D#uuid
...
**重写:** THING.BaseTickableObject3D#tags
...
**重写:** THING.BaseTickableObject3D#userData
...
**重写:** THING.BaseTickableObject3D#destroyable
...
**重写:** THING.BaseTickableObject3D#queryable
...
**重写:** THING.BaseTickableObject3D#parent
...
**重写:** THING.BaseTickableObject3D#relationships
...
**重写:** THING.BaseTickableObject3D#parents
...
**重写:** THING.BaseTickableObject3D#brothers
...
**重写:** THING.BaseTickableObject3D#children
...
**重写:** THING.BaseTickableObject3D#components
...
**描述:** 开始生成扫描区域，每帧扫描一条水平线

#### 参数

| 名称 | 类型 | 描述 |
|------|------|-------------|
| `scanningObject` | `Array.<Object3D>` | 要扫描的对象 |
| `update` | `boolean` | 场景矩阵是否需要更新 |
| `useCache` | `boolean` | 是否尝试使用存储在浏览器缓存（localStorage）中的扫描值，可以提高性能 |
| `saveCache` | `boolean` | 扫描结束后是否自动将扫描结果存储在浏览器缓存（localStorage）中浏览器缓存的键为 name + '_scanning_data'，所以如果场景中有多个需要缓存的视锥体扫描结果，注意设置不同的名称 |
...
| 名称 | 类型 | 描述 |
|------|------|-------------|
| `testObjects` | `Array.<Object3D>` | 检测对象范围 |
...
- **类型:** `number`
- **描述:** - 0 表示 OUT，1 表示 VISIBLE，2 表示 OBSCURED，-1 表示检查错误
...
**重写:** THING.BaseTickableObject3D#getVisible
...
**重写:** THING.BaseTickableObject3D#setVisible
...
**重写:** THING.BaseTickableObject3D#setPickable
...
**重写:** THING.BaseTickableObject3D#getFrustumCulled
...
**重写:** THING.BaseTickableObject3D#setFrustumCulled
...
**重写:** THING.BaseTickableObject3D#distanceTo
...
**重写:** THING.BaseTickableObject3D#add
...
**重写:** THING.BaseTickableObject3D#promoteNode
...
**重写:** THING.BaseTickableObject3D#raycast
...
**重写:** THING.BaseTickableObject3D#setStyle
...
**重写:** THING.BaseTickableObject3D#clone
...
**重写:** THING.BaseTickableObject3D#waitForComplete
...
**重写:** THING.BaseTickableObject3D#loadResource
...
**重写:** THING.BaseTickableObject3D#unloadResource
...
**重写:** THING.BaseTickableObject3D#copy
...
**重写:** THING.BaseTickableObject3D#getRenderOrder
...
**重写:** THING.BaseTickableObject3D#setRenderOrder
...
**重写:** THING.BaseTickableObject3D#makeInstancedDrawing
...
**重写:** THING.BaseTickableObject3D#enableInstancing
...
**重写:** THING.BaseTickableObject3D#disableInstancing
...
**重写:** THING.BaseTickableObject3D#setInstancing
...
**重写:** THING.BaseTickableObject3D#getInstancing
...
**重写:** THING.BaseTickableObject3D#setInstancingColor
...
**重写:** THING.BaseTickableObject3D#setInstancingClearOutColor
...
**重写:** THING.BaseTickableObject3D#getInstancingClearOutColor
...
**重写:** THING.BaseTickableObject3D#setInstancingDiffuseUVTransform
...
**重写:** THING.BaseTickableObject3D#getInstancingDiffuseUVTransform
...
**重写:** THING.BaseTickableObject3D#setInstancingVisible
...
**重写:** THING.BaseTickableObject3D#getInstancingVisible
...
**重写:** THING.BaseTickableObject3D#getInstancedCount
...
**重写:** THING.BaseTickableObject3D#setInstancingMatrix
...
**重写:** THING.BaseTickableObject3D#getInstancingMatrix
...
**重写:** THING.BaseTickableObject3D#setInstancingAttribute
...
**重写:** THING.BaseTickableObject3D#getInstancingAttribute
...
**重写:** THING.BaseTickableObject3D#getAABB
...
**重写:** THING.BaseTickableObject3D#getOBB
...
**重写:** THING.BaseTickableObject3D#stopMoving
...
**重写:** THING.BaseTickableObject3D#pauseMoving
...
**重写:** THING.BaseTickableObject3D#resumeMoving
...
**重写:** THING.BaseTickableObject3D#moveTo
...
**重写:** THING.BaseTickableObject3D#movePath
...
**重写:** THING.BaseTickableObject3D#movePathAsync
...
**重写:** THING.BaseTickableObject3D#stopScaling
...
**重写:** THING.BaseTickableObject3D#pauseScaling
...
**重写:** THING.BaseTickableObject3D#resumeScaling
...
**重写:** THING.BaseTickableObject3D#scaleTo
...
**重写:** THING.BaseTickableObject3D#stopRotating
...
**重写:** THING.BaseTickableObject3D#pauseRotating
...
**重写:** THING.BaseTickableObject3D#resumeRotating
...
**重写:** THING.BaseTickableObject3D#rotateTo
...
**重写:** THING.BaseTickableObject3D#stopFading
...
**重写:** THING.BaseTickableObject3D#pauseFading
...
**重写:** THING.BaseTickableObject3D#resumeFading
...
**重写:** THING.BaseTickableObject3D#fadeIn
...
**重写:** THING.BaseTickableObject3D#fadeOut
...
**重写:** THING.BaseTickableObject3D#fadeInAsync
...
**重写:** THING.BaseTickableObject3D#fadeOutAsync
...
**重写:** THING.BaseTickableObject3D#stopFlying
...
**重写:** THING.BaseTickableObject3D#pauseFlying
...
**重写:** THING.BaseTickableObject3D#resumeFlying
...
**重写:** THING.BaseTickableObject3D#flyTo
...
**重写:** THING.BaseTickableObject3D#fit
...
**重写:** THING.BaseTickableObject3D#stopUVTransform
...
**重写:** THING.BaseTickableObject3D#pauseUVTransform
...
**重写:** THING.BaseTickableObject3D#resumeUVTransform
...
**重写:** THING.BaseTickableObject3D#uvTransformTo
...
**重写:** THING.BaseTickableObject3D#rotate
...
**重写:** THING.BaseTickableObject3D#rotateOnAxis
...
**重写:** THING.BaseTickableObject3D#rotateX
...
**重写:** THING.BaseTickableObject3D#rotateY
...
**重写:** THING.BaseTickableObject3D#rotateZ
...
**重写:** THING.BaseTickableObject3D#translateX
...
**重写:** THING.BaseTickableObject3D#translateY
...
**重写:** THING.BaseTickableObject3D#translateZ
...
**重写:** THING.BaseTickableObject3D#translate
...
**重写:** THING.BaseTickableObject3D#lookAt
...
**重写:** THING.BaseTickableObject3D#worldToSelf
...
**重写:** THING.BaseTickableObject3D#selfToWorld
...
**重写:** THING.BaseTickableObject3D#localToWorld
...
**重写:** THING.BaseTickableObject3D#worldToLocal
...
**重写:** THING.BaseTickableObject3D#hasAttribute
...
**重写:** THING.BaseTickableObject3D#getAttribute
...
**重写:** THING.BaseTickableObject3D#setAttribute
...
**重写:** THING.BaseTickableObject3D#setAttributes
...
**重写:** THING.BaseTickableObject3D#destroy
...
**重写:** THING.BaseTickableObject3D#on
...
**重写:** THING.BaseTickableObject3D#once
...
**重写:** THING.BaseTickableObject3D#off
...
**重写:** THING.BaseTickableObject3D#pauseEvent
...
**重写:** THING.BaseTickableObject3D#resumeEvent
...
**重写:** THING.BaseTickableObject3D#trigger
...
**重写:** THING.BaseTickableObject3D#invoke
...
**重写:** THING.BaseTickableObject3D#remove
...
**重写:** THING.BaseTickableObject3D#traverse
...
**重写:** THING.BaseTickableObject3D#query
...
**重写:** THING.BaseTickableObject3D#queryAll
...
**重写:** THING.BaseTickableObject3D#queryByName
...
**重写:** THING.BaseTickableObject3D#queryById
...
**重写:** THING.BaseTickableObject3D#queryByTags
...
**重写:** THING.BaseTickableObject3D#queryByUUID
...
**重写:** THING.BaseTickableObject3D#queryByType
...
**重写:** THING.BaseTickableObject3D#queryByDTType
...
**重写:** THING.BaseTickableObject3D#queryByUserData
...
**重写:** THING.BaseTickableObject3D#queryByRegExp
...
**重写:** THING.BaseTickableObject3D#addComponent
...
**重写:** THING.BaseTickableObject3D#removeComponent
...
**重写:** THING.BaseTickableObject3D#removeAllComponents
...
**重写:** THING.BaseTickableObject3D#traverseComponentByType
...
**重写:** THING.BaseTickableObject3D#getComponentByName
...
**重写:** THING.BaseTickableObject3D#getComponentByType
...
**重写:** THING.BaseTickableObject3D#getComponentsByType
...
**重写:** THING.BaseTickableObject3D#getAllComponents
...
**重写:** THING.BaseTickableObject3D#hasComponent
