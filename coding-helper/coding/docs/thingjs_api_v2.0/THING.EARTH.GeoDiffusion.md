...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | - |
| param.coordinates | `Array.<Number>` | - | 否 | 扫光中心点坐标 |
| param.id | `String, Number` | - | 是 | 地理物体对象ID |
...
| param.scanLayers | `Array.<Layer>` | - | 是 | 接受扫光的图层集合 |
| param.style | `THING.EARTH.GeoDiffusionStyle` | - | 否 | 样式效果 |
| param.onComplete | `function` | - | 是 | 创建完毕后的回调 |
