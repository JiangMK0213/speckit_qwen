...
**继承:** [THING.IDWmap](./THING.IDWmap.md)
...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | 参数列表 |
| param.variogramModel | `VariogramModel` | `THING.VariogramModel.Exponential` | 是 | 计算变差函数时使用的模型 |
| param.extent | `Object` | - | 是 | 热力图展示的范围 例如{minX:-50,minY:-50,maxX:50,maxY:50} 数值单位是米 代表绝对坐标 |
...
| param.minTransparentValue | `Number` | `-Infinity` | 是 | 展示结果时,小于minTransparentValue,颜色会变为透明 |
| param.maxTransparentValue | `Number` | `Infinity` | 是 | 展示结果时,maxTransparentValue,颜色会变为透明 |
| param.gradient | `Object` | `false` | 是 | 渲染插值图使用的色带 |
| param.maskShape | `Object3D` | - | 是 | 基于maskShape作为展示插值图的对象 这里需要注意maskShape是一个xz平面的片,非地球模式下生效 |
| param.mask | `Array` | - | 是 | 渲染插值图使用的遮罩,格式为:{
...
**重写:** THING.IDWmap#localQuaternion
...
**重写:** THING.IDWmap#ignoreParentTransform
...
**重写:** THING.IDWmap#updateMapViewExtent
...
**重写:** THING.IDWmap#getFrustumCulled
...
**重写:** THING.IDWmap#setFrustumCulled
...
**重写:** THING.IDWmap#waitForComplete
...
**重写:** THING.IDWmap#unloadResource
...
**重写:** THING.IDWmap#getRenderOrder
...
**重写:** THING.IDWmap#setRenderOrder
...
**重写:** THING.IDWmap#makeInstancedDrawing
...
**重写:** THING.IDWmap#enableInstancing
...
**重写:** THING.IDWmap#disableInstancing
...
**重写:** THING.IDWmap#setInstancingColor
...
**重写:** THING.IDWmap#setInstancingClearOutColor
...
**重写:** THING.IDWmap#getInstancingClearOutColor
...
**重写:** THING.IDWmap#setInstancingDiffuseUVTransform
...
**重写:** THING.IDWmap#getInstancingDiffuseUVTransform
...
**重写:** THING.IDWmap#setInstancingVisible
...
**重写:** THING.IDWmap#getInstancingVisible
...
**重写:** THING.IDWmap#getInstancedCount
...
**重写:** THING.IDWmap#setInstancingMatrix
...
**重写:** THING.IDWmap#getInstancingMatrix
...
**重写:** THING.IDWmap#setInstancingAttribute
...
**重写:** THING.IDWmap#getInstancingAttribute
...
**重写:** THING.IDWmap#resumeRotating
...
**重写:** THING.IDWmap#stopUVTransform
...
**重写:** THING.IDWmap#pauseUVTransform
...
**重写:** THING.IDWmap#resumeUVTransform
...
**重写:** THING.IDWmap#queryByUserData
...
**重写:** THING.IDWmap#removeComponent
...
**重写:** THING.IDWmap#removeAllComponents
...
**重写:** THING.IDWmap#traverseComponentByType
...
**重写:** THING.IDWmap#getComponentByName
...
**重写:** THING.IDWmap#getComponentByType
...
**重写:** THING.IDWmap#getComponentsByType
...
**重写:** THING.IDWmap#getAllComponents
