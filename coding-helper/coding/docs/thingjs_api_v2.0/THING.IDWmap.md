...
**继承:** [THING.Heatmap](./THING.Heatmap.md)
...
|------|------|--------|-------------|--------|
| param | `Object` | - | 否 | 参数列表 |
| param.exponent | `Number` | `2` | 是 | 计算权重使用的幂值 |
| param.radius | `Number` | `100` | 是 | 计算权重时使用的半径 插值时从待求点向外搜索距离在radius之内的点进行计算 单位米 |
...
| param.minTransparentValue | `Number` | - | 是 | 展示结果时,小于minTransparentValue,颜色会变为透明 |
...
**重写:** THING.Heatmap#extrudeHeight
...
**重写:** THING.Heatmap#isDynamicLoad
...
**重写:** THING.Heatmap#frustumCulled
...
**重写:** THING.Heatmap#localPosition
...
**重写:** THING.Heatmap#localRotation
...
**重写:** THING.Heatmap#localQuaternion
...
**重写:** THING.Heatmap#ignoreParentTransform
...
**重写:** THING.Heatmap#relationships
...
**重写:** THING.Heatmap#updateMapViewExtent
...
**重写:** THING.Heatmap#getFrustumCulled
...
**重写:** THING.Heatmap#setFrustumCulled
...
**重写:** THING.Heatmap#waitForComplete
...
**重写:** THING.Heatmap#unloadResource
...
**重写:** THING.Heatmap#getRenderOrder
...
**重写:** THING.Heatmap#setRenderOrder
...
**重写:** THING.Heatmap#makeInstancedDrawing
...
**重写:** THING.Heatmap#enableInstancing
...
**重写:** THING.Heatmap#disableInstancing
...
**重写:** THING.Heatmap#setInstancing
...
**重写:** THING.Heatmap#getInstancing
...
**重写:** THING.Heatmap#setInstancingColor
...
**重写:** THING.Heatmap#setInstancingClearOutColor
...
**重写:** THING.Heatmap#getInstancingClearOutColor
...
**重写:** THING.Heatmap#setInstancingDiffuseUVTransform
...
**重写:** THING.Heatmap#getInstancingDiffuseUVTransform
...
**重写:** THING.Heatmap#setInstancingVisible
...
**重写:** THING.Heatmap#getInstancingVisible
...
**重写:** THING.Heatmap#getInstancedCount
...
**重写:** THING.Heatmap#setInstancingMatrix
...
**重写:** THING.Heatmap#getInstancingMatrix
...
**重写:** THING.Heatmap#setInstancingAttribute
...
**重写:** THING.Heatmap#getInstancingAttribute
...
**重写:** THING.Heatmap#movePathAsync
...
**重写:** THING.Heatmap#resumeScaling
...
**重写:** THING.Heatmap#pauseRotating
...
**重写:** THING.Heatmap#resumeRotating
...
**重写:** THING.Heatmap#stopUVTransform
...
**重写:** THING.Heatmap#pauseUVTransform
...
**重写:** THING.Heatmap#resumeUVTransform
...
**重写:** THING.Heatmap#uvTransformTo
...
**重写:** THING.Heatmap#setAttributes
...
**重写:** THING.Heatmap#queryByDTType
...
**重写:** THING.Heatmap#queryByUserData
...
**重写:** THING.Heatmap#queryByRegExp
...
**重写:** THING.Heatmap#removeComponent
...
**重写:** THING.Heatmap#removeAllComponents
...
**重写:** THING.Heatmap#traverseComponentByType
...
**重写:** THING.Heatmap#getComponentByName
...
**重写:** THING.Heatmap#getComponentByType
...
**重写:** THING.Heatmap#getComponentsByType
...
**重写:** THING.Heatmap#getAllComponents
